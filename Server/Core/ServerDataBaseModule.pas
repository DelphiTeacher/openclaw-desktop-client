...
//  SQLServerUniProvider,
  ...
  UniProvider, Data.DB, DBAccess, Uni, SQLServerUniProvider,MySQLUniProvider,SQLiteUniProvider,PostgreSQLUniProvider,
  kbmMWUniDAC,
...
//  TDatabaseModuleList=class(TBaseList)
//  private
//    function GetItem(Index: Integer): TDatabaseModule;
//  public
//  public
//    procedure SaveToJsonArray(AJsonArray:ISuperArray);
//    procedure LoadFromJsonArray(AJsonArray:ISuperArray);
//    property Items[Index:Integer]:TDatabaseModule read GetItem;default;
//  end;
...
//          FreeAndNil(AOptions);
          ...
          try
              ...
              if SameText(DBConfig.FDBType,'MYSQL')
                or SameText(DBConfig.FDBType,'MSSQL')
                or SameText(DBConfig.FDBType,'SQLSERVER')
                or SameText(DBConfig.FDBType,'MSSQL2000')
                or SameText(DBConfig.FDBType,'SQLSERVER2000')
                then
              begin
...
//{ TDatabaseModuleList }
//
//function TDatabaseModuleList.GetItem(Index: Integer): TDatabaseModule;
//begin
//  Result:=TDatabaseModule(Inherited Items[Index]);
//end;
//
//procedure TDatabaseModuleList.LoadFromJsonArray(AJsonArray: ISuperArray);
//var
//  I: Integer;
//  ADatabaseModule:TDatabaseModule;
//begin
//  Clear;
//  for I := 0 to AJsonArray.Length-1 do
//  begin
//    ADatabaseModule:=TDatabaseModule.Create;
...
//end;
//
//procedure TDatabaseModuleList.SaveToJsonArray(AJsonArray: ISuperArray);
//var
//  I: Integer;
//  ADatabaseModule:TDatabaseModule;
//begin
...
//  begin
//    ADatabaseModule:=TDatabaseModule(Items[I]);
