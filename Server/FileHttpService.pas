...
type
  TkbmMWEventFileHTTPService = class(TkbmMWEventHTTPService)
  private
...
{$IFNDEF CPP}class{$ENDIF} function TkbmMWEventFileHTTPService.GetPrefServiceName:string;
begin
     Result:='HTTPSERVICE';
end;

{$IFNDEF CPP}class{$ENDIF} function TkbmMWEventFileHTTPService.GetFlags:TkbmMWServiceFlags;
begin
     Result:=[mwsfListed];
end;
