...
//    procedure SetItem(Index:Integer; const Value: TUrlCacheItem);
  protected
    function CreateBinaryObject(const AClassName:String=''):TObject;override;
  public
...
begin
  ...
  try
    ...
    FListItemStyleReg:=RegisterListItemStyle(//'CustomListItemStyle_ProcessTaskOrder',
                                              ...
                                              FPage.FRecordListFieldControlSetting.PropJson.F['ItemHeight'],

                                              //列表项样式是否自动计算尺寸
                                              //(FPage.list_item_style_autosize=1),
                                              FPage.FRecordListFieldControlSetting.PropJson.B['ItemStyleAutoSize'],
