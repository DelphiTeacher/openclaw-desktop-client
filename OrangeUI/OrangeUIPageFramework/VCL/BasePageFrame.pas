...
//  BasePageFrame,
  ...
  uSkinButtonType, Vcl.Controls, Vcl.ExtCtrls,uPageStructure,
  uSkinWindowsControl;

type
  TFrameBasePage = class(TFrame,IFrameHistroyReturnEvent,IPageFrameworkFrame)
    pnlToolbar: TPanel;
    pnlBottombar: TPanel;
    pnlClient: TPanel;
...
//    procedure Init;
  protected
    ...
    procedure DoPageInstanceCustomCallSaveDataIntfEvent(Sender:TObject;
                                            APageInstance:TObject;
                                            var ASaveDataSetting:TSaveDataSetting;
                                            ASaveDataIntfResult:TDataIntfResult;
                                            var AIsNeedCallDefault:Boolean);virtual;
  public
...
//  FPageInstance.OnLoadDataTaskEnd:=DoLoadDataTaskEnd;
  ...
  Self.FPageInstance.OnCustomCallSaveDataIntf:=DoPageInstanceCustomCallSaveDataIntfEvent;
...
procedure TFrameBasePage.DoPageInstanceCustomCallSaveDataIntfEvent(Sender,
  APageInstance: TObject; var ASaveDataSetting: TSaveDataSetting;
  ASaveDataIntfResult: TDataIntfResult;
