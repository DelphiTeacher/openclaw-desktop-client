...
begin
  ...
  begin
      AFieldDef:=ADataset.FieldDefs[J];
//      uBaseLog.HandleException(nil,AFieldDef.Name);
      ...
      try
        ...
        //  end;
          ...
          if (AMemTable.FieldDefs.Count=0)
            or (ADataJson.A[ARecordListKey+'_'+'FieldDefs'].Length>0) and (AMemTable.FieldDefs.Count<>ADataJson.A[ARecordListKey+'_'+'FieldDefs'].Length) then
          begin
            //每次都重建
