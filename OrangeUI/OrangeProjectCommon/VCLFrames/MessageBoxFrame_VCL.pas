...
//  VCL.Objects,
  ...
  uBaseSkinControl, uSkinPanelType, uSkinWindowsMyComboBox;//, VCL.Controls.Presentation, VCL.Edit;
...
//                          IFrameVirtualKeyboardAutoProcessEvent)
    ...
    pnlInput3: TSkinWinPanel;
    cmbInput3: TSkinWinMyComboBox;
...
begin
  Self.pnlMessageBox.Width:=Width;
...
//    if ACustomControl.Width>Width then
//    begin
      Width:=ACustomControl.Width;
//    end;
    {$IFDEF FMX}
  ...
  Self.pnlInput3.Visible:=(AInputEditCount>2);
...
//    Self.pnlInput1.Material.BackColor.BorderWidth:=1;
  ...
  if Self.pnlInput3.Visible then
  begin
    AMessageBoxHeight:=AMessageBoxHeight+pnlInput3.Height;
//    Self.pnlInput1.Material.BackColor.BorderWidth:=1;
  end;
//  else
//  begin
