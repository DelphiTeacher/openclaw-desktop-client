...
procedure ShowHintFrame(AParent:TForm;AHint:String;AWaitSeconds:Integer=3);
...
//  ShowMessage(AHint);
  ...
  AfrmHint.FWaitSeconds:=AWaitSeconds;
...
begin
  ...
  else if Self.tmrWaiting.Interval*Self.tmrWaiting.Tag<Self.FWaitSeconds*1000 then
  begin
    //渐渐透明  (255 div FWaitSeconds)
    AAlpha:=Ceil(255 / (FWaitSeconds*1000 / Self.tmrWaiting.Interval));
    if Self.AlphaBlendValue-AAlpha>0 then
    begin
      Self.AlphaBlendValue:=Self.AlphaBlendValue-AAlpha;
    end;
  end
  else
  begin
