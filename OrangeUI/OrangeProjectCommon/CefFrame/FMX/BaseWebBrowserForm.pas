...
//    FDefaultUrl:String;
    ...
    procedure CreateWebBrowserFrame(AFrameClass:TFrameBaseWebBrowserClass);
    { Public declarations }
  end;
...
//  FBaseWebBrowserFrame.Align:=TAlignLayout.Client;
end;
...
procedure TfrmBaseWebBrowser.CreateWebBrowserFrame(
  AFrameClass: TFrameBaseWebBrowserClass);
begin
  //
  if FBaseWebBrowserFrame=nil then
  begin
    FBaseWebBrowserFrame:=AFrameClass.Create(Self);
    FBaseWebBrowserFrame.FOnCanFree:=DoBaseWebBrowserFrameCanFree;
    FBaseWebBrowserFrame.Parent:=Self;
    FBaseWebBrowserFrame.Align:=TAlignLayout.Client;
  end;

//  FBaseWebBrowserFrame.DefaultURL:=FDefaultURL;
