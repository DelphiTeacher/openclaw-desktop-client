...
//  signature := Base64Encode(EncryptHMACSha1(string_to_sign, 'KZo149BD9GLPNiDIEmdQ7dyNKG****'));
  //Mhb1MkIfOlZTnBXZE5Hleb/2****


  //阿里云OSS文档https://help.aliyun.com/document_detail/375247.html?spm=a2c4g.375302.0.0
//  AAliOssFileSystem:=TAliOssFileSystem.Create('Lx7DqDlEL3onWBYt',
//                                              'PSp2Csp8JjDInalmXnpX5XbsIgCFdI',
...
//  AAliOssFileSystem:=TAliOssFileSystem.Create('LTAI5tKsomHkgJjvr1dgY6sV',
//                                              '3LDFmPaMio69OOUNs6rFNMylPuUlyE',
//                                              'oss-cn-hangzhou.aliyuncs.com',
//                                              False,
//                                              True
//                                              );
...
//                                              'STS.NUBQen4KXJKuyy8a5bH8UtYuq',
//                                              '9DYS5pvqVgDWUzmGKPMvKzuddFuH3Qdh4ZKKqKMXGtno',
//                                              'oss-cn-hangzhou.aliyuncs.com',
//                                              False,
//                                              True,
//                                              'CAISggJ1q6Ft5B2yfSjIr5b3Gt/a2ZR5/Ymee1+JhTU3RLd5m5zekzz2'
...
//  FreeAndNil(AAliOssFileSystem);
  ...
  AAliOssFileSystem:=TAliOssFileSystem.Create(
                                              'LTAI5tFbGj5ZHwgRkTGMMsDN',
                                              'rAN1wSEjNymIxf0t6Pshh3D1Af9Wlx',
