...
type
  ...
  public
    ...
    function Put(const AHttpUrl:String;ARequestStream:TStream;AResponseStream:TStream):Boolean;overload;virtual;abstract;
...
//    procedure DoNetHTTPClientReceiveData(const Sender: TObject; AContentLength,AReadCount: Int64; var Abort: Boolean);virtual;
    procedure DoValidateCertificate(const Sender: TObject; const ARequest: TURLRequest; const Certificate: TCertificate; var Accepted: Boolean);
  public
...
//    TCookies = class(TList<TCookie>);
    ...
    function Put(const AHttpUrl:String;ARequestStream:TStream;AResponseStream:TStream):Boolean;overload;override;
...
//  FNetHTTPClient.OnNeedClientCertificate:=DoNeedClientCertificate;
  FNetHTTPClient.OnValidateServerCertificate:=DoValidateCertificate;
end;
...
procedure TSystemHttpControl.DoValidateCertificate(const Sender: TObject; const ARequest: TURLRequest; const Certificate: TCertificate; var Accepted: Boolean);
begin
  Accepted:=True;
end;
...
begin
    ...
    try
      ...
      FHTTPResponse:=FNetHTTPClient.Post(AHttpUrl,
                          ARequestStream,
                          AResponseStream,
...
function TSystemHttpControl.Put(const AHttpUrl: String; ARequestStream,AResponseStream: TStream): Boolean;
begin
    Result:=False;

    try

      FNetHTTPClient.Put(AHttpUrl,
                          ARequestStream,
                          AResponseStream,
                          FNetHTTPRequestHeaders);
