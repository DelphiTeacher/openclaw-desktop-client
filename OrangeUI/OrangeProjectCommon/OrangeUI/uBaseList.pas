...
type
  ...
  ///   </para>
  /// </summary>
  TItemDeleteEvent=procedure(Sender:TObject;AItem:TObject) of object;
...
begin
  ...
  begin
    if TObject(Self.FItems[I])=AObject then
    begin
      Result:=I;
      Break;
    end;
...
var
  ASrcPointer:TObject;
begin
  ASrcPointer:=TObject(Self.FItems[ASrcIndex]);
