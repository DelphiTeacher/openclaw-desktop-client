...
begin
  ...
  try
    ...
    //              AUniConnection.SpecificOptions.Values['Charset']:='utf16';
//                  AUniConnection.SpecificOptions.Values['UseUnicode']:='True';
              ...
              begin
                ...
                AUniConnection.SpecificOptions.Values['JournalMode']:='jmWAL';
                {$ENDIF}
    ...
    //            {$ENDIF}
                ...
                //unidac file is encrypted or is not a database
...
//                [soWriteBOM,soTrailingLineBreak,soUseLocale], (('MySQL.Charset=utf8mb4', nil), ('MySQL.UseUnicode=True', nil), ('', nil), ('', nil)), 2, 4, False, dupIgnore, False, (Uni.TSpecificOptionsHolder.ValuesChanged,$622EE98), (Uni.TUniConnectionSpecificOptions.ValuesChanging,$622EE98), False, [])
                //PostgreSQL
                AUniConnection.ProviderName:='PostgreSQL';

                AUniConnection.SpecificOptions.Clear;
//                AUniConnection.SpecificOptions.Values['Charset']:=ADataBaseConfig.FDBCharset;//GlobalDataBaseCharset;'utf8mb4';//
//                AUniConnection.SpecificOptions.Values['UseUnicode']:='True';
                if ADataBaseConfig.FDBSchema<>'' then
                begin
                  AUniConnection.SpecificOptions.values['schema']:=ADataBaseConfig.FDBSchema;
                end;
...
//              begin
//                AUniConnection.ExecSQL('PRAGMA journal_mode=WAL');
//              end;

//              AUniConnection.ExecSQL('INSERT INTO tbluser  (createtime,is_deleted,fid,login_user,password,name,role_fid,roles,appid)  VALUES  (''2024-11-02 20:06:37'',0,''C13294D24F484BE38BAC861D87B5DDC9'',''66'',''66'',''66'',0,'''',1041);SELECT * from tbluser where fid=''C13294D24F484BE38BAC861D87B5DDC9'' ');
