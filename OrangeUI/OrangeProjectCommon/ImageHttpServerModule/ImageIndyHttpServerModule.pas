...
//                    PWideChar(ADestDir+ATempFileName));
    TFile.Move(dmImageIndyHttpServer.WWWRootDir+'Temp\'+ATempFileName,
                    ADestDir+ATempFileName);
...
//                      PWideChar(ADestDir+const_ThumbPrefix+ATempFileName));
      TFile.Move(dmImageIndyHttpServer.WWWRootDir+'Temp\'+const_ThumbPrefix+ATempFileName,
                      ADestDir+const_ThumbPrefix+ATempFileName);
    end;
