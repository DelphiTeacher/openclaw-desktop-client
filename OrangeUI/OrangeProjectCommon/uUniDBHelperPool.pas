...
//  {$IFDEF FMX}
  if SameText(AUniDBHelperPool.FDBConfig.FDBType,'MSSQL') or SameText(AUniDBHelperPool.FDBConfig.FDBType,'MSSQL2000') or SameText(AUniDBHelperPool.FDBConfig.FDBType,'SQLSERVER') or SameText(AUniDBHelperPool.FDBConfig.FDBType,'SQLSERVER2000') then
  begin
    {$IFDEF MSWINDOWS}
    CoInitialize(nil);
    {$ENDIF}
