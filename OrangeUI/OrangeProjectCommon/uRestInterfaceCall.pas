...
type
//  THttpMethodType=(hmtGet,hmtPost,hmtPost,hmtDelete);
...
function SaveRecordToServer(AInterfaceUrl:String;
                            ...
                            AUpdateWhereKeyJson:String='';
                            AIsAddRecord:Boolean=False):Boolean;
...
begin
  ...
  if AFIDIsEmpty or AIsAddRecord then
  begin
