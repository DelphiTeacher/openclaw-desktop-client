...
//  uBaseLog.HandleException(nil,'OrangeUI','uSkinFireMonkeyControl',Name+' '+ClassName+' '+'TSkinFireMonkeyControl.Destroy'+' '+IntToStr(Integer(Self)));
  ...
  try
    ...
    on E:Exception do
    begin
      uBaseLog.HandleException(E,'OrangeUI','uSkinFireMonkeyControl',Name+' '+ClassName+' '+'FreeAndNil(FDrawCanvas);');
    end;
  end;
...
//    end;
    ...
    begin
      ...
      GetSkinControlType.Paint(FDrawCanvas,GetSkinControlType.GetPaintCurrentUseMaterial,RectF(0,0,Self.Width,Self.Height),FPaintData);
    end;
