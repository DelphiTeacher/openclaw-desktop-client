...
begin
    ...
    begin
      ...
      GetSkinControlType.Paint(FDrawCanvas,ASkinMaterial,RectF(0,0,Self.Width,Self.Height),FPaintData);
    end;
...
function TSkinFMXCustomMemo.EditGetValue:Variant;
begin
  Result:=Self.Text;
end;

procedure TSkinFMXCustomMemo.EditSetValue(const AValue:Variant);
begin
  Self.Text:=AValue;
end;
