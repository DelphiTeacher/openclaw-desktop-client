...
//生成控件的预览效果图
function MakeSkinControlSnapshot(AControl:TControl;AClearColor:TColor):TBitmap;
...
begin
  Result:=TBitmap.Create(Ceil(AControl.Width*Const_BufferBitmapScale),Ceil(AControl.Height*Const_BufferBitmapScale));
  ...
  try
    ...
    (AControl as ISkinControl).GetSkinControlType.Paint(ADrawCanvas,
                                    (AControl as ISkinControl).GetSkinControlType.GetPaintCurrentUseMaterial,
