...
//是否下拉框弹出了
function TSkinFMXCustomComboBox.GetIsDropedDown:Boolean;
begin
  Result:=False;
end;

function TSkinFMXCustomComboBox.GetViewType: TSkinComboBoxViewType;
begin
...
function TSkinFMXCustomComboBox.EditGetValue:Variant;
begin
  Result:=GetText;
end;

procedure TSkinFMXCustomComboBox.EditSetValue(const AValue:Variant);
begin
