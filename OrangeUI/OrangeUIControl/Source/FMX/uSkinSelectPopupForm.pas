...
function CreateSkinSelectPopupForm(AOwnerForm:TComponent;AfrmSkinSelectPopupClass:TfrmSkinSelectPopupClass):TfrmSkinSelectPopup;
...
function CreateSkinSelectPopupForm(AOwnerForm:TComponent;AfrmSkinSelectPopupClass:TfrmSkinSelectPopupClass):TfrmSkinSelectPopup;//(WndParent:TForm);
begin
