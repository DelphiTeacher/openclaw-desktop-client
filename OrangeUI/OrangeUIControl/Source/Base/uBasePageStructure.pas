...
//    IsNoPost:String;
  ...
  published
    ...
    property data_source_name:String read Fdata_source_name write Fdata_source_name;
...
begin
  ...
  begin
    ...
    ADest.field_caption:=field_caption;
    ADest.data_source_name:=data_source_name;
    //控件风格
