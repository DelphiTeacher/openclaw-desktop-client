...
//    function GetDrawCanvas: TDrawCanvas;
  ...
  public
    ...
    procedure DrawTo(ACanvas:TCanvas;ADestRect:TRectF);
  public
...
//    function GetScale:Single;
  ...
  public
    ...
    procedure DrawTo(ACanvas:TCanvas;ADestRect:TRectF);virtual;abstract;
  public
...
//    property Height:Integer read GetHeight;
  ...
  public
    ...
    procedure DrawTo(ACanvas:TCanvas;ADestRect:TRectF);override;
    //{$IFDEF VCL}
...
procedure TWindowsBitmap.DrawTo(ACanvas:TCanvas;ADestRect:TRectF);
begin
...
procedure TFMXPlatformBitmap.DrawTo(ACanvas:TCanvas;ADestRect:TRectF);
begin
  ACanvas.DrawBitmap(Self.FBitmap,RectF(0,0,FBitmap.Width,FBitmap.Height),ADestRect,1);
end;


function TFMXPlatformBitmap.SetSize(AWidth:Integer;AHeight:Integer;AScale:Single): Boolean;
begin
  Result:=False;
  try
...
//  FPlatformBitmap.PixelFormat:=TPixelFormat.pf32bit;
  ...
  //TBitmap没有Scale
  {$IFDEF FMX}
  FPlatformBitmap.SetSize(AWidth,AHeight,AScale);
  {$ENDIF}
  {$IFDEF VCL}
...
procedure TBufferBitmap.DrawTo(ACanvas:TCanvas;ADestRect:TRectF);
begin
//  Bitblt(ACanvas.Handle,0,0,
//         Self.Width,
//         Self.Height,
...
//         SRCCOPY);
  ...
  {$ELSE}
  FPlatformBitmap.DrawTo(ACanvas,ADestRect);
  {$ENDIF}
