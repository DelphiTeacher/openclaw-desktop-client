...
//    procedure DoAnimateEnd(ASkinAnimator:TSkinAnimator);
  ...
  TValueChangeEffect=class(TBaseControlEffect)
  public
    FValueChangeEffectIntf:IValueChangeEffect;
//    FFrom: Double;
//    FDest: Double;
//    FCurrent:Double;
  protected
    procedure DoAnimate(ASkinAnimator:TSkinAnimator);virtual;
    procedure DoAnimateBegin(ASkinAnimator:TSkinAnimator);virtual;
    procedure DoAnimateEnd(ASkinAnimator:TSkinAnimator);virtual;
  end;
  TValueChangeEffectList=class(TBaseList)
  protected
    function GetItem(Index: Integer): TValueChangeEffect;
//    procedure SetItem(Index: Integer; const Value: TValueChangeEffect);
//  public
//    constructor Create;
  public
    property Items[Index:Integer]:TValueChangeEffect read GetItem;default;// write SetItem;default;
  end;

  TValueChangeEffectAnimator=class(TSkinAnimator)
  private
//    procedure SetControlEffectItems(const Value: TControlEffectItems);
  protected
    procedure DoAnimate(Sender:TObject;var NeedStop:Boolean);override;
    ...
    procedure DoAnimateEnd(Sender:TObject);override;
  public
    FValueChangeEffectList: TValueChangeEffectList;
    constructor Create(AOwner:TComponent);override;
    destructor Destroy;override;
    procedure AddEffect(AValueChangeEffectIntf:IValueChangeEffect);
//  published
//    //
//    /// <summary>
//    ///   <para>
...
//    ///   </para>
//    /// </summary>
//    property ControlEffectItems:TControlEffectItems read FValueChangeEffectList write SetControlEffectItems;
  end;
...
procedure TValueChangeEffect.DoAnimate(ASkinAnimator: TSkinAnimator);
begin
  if not FIsEnabled then Exit;

  if IsNotSameDouble(FValueChangeEffectIntf.GetFrom,FValueChangeEffectIntf.GetDest) then
  begin
    case ASkinAnimator.FDirectionType of
      adtForward:
      begin
        FValueChangeEffectIntf.SetCurrent(FValueChangeEffectIntf.GetFrom+ASkinAnimator.GetProgress*(FValueChangeEffectIntf.GetDest-FValueChangeEffectIntf.GetFrom));
      end
      ;
      adtBackward:
      begin
        FValueChangeEffectIntf.SetCurrent(FValueChangeEffectIntf.GetDest-ASkinAnimator.GetProgress*(FValueChangeEffectIntf.GetDest-FValueChangeEffectIntf.GetFrom));
      end;
    end;
  end;
...
procedure TValueChangeEffect.DoAnimateBegin(ASkinAnimator: TSkinAnimator);
begin
  if not FIsEnabled then Exit;
  FValueChangeEffectIntf.SetCurrent(FValueChangeEffectIntf.GetFrom);
end;

procedure TValueChangeEffect.DoAnimateEnd(ASkinAnimator: TSkinAnimator);
begin
  if not FIsEnabled then Exit;
  FValueChangeEffectIntf.SetCurrent(FValueChangeEffectIntf.GetDest);
end;



{ TValueChangeEffectList }

//constructor TValueChangeEffectList.Create();//(AControlEffectAnimator: TControlEffectAnimator);
//begin
//  Inherited Create(TControlEffectItem);
////  FControlEffectAnimator:=AControlEffectAnimator;
//end;

function TValueChangeEffectList.GetItem(Index: Integer): TValueChangeEffect;
begin
  Result:=TValueChangeEffect(Inherited Items[Index]);
end;

//procedure TValueChangeEffectList.SetItem(Index: Integer;const Value: TValueChangeEffect);
//begin
//  Inherited Items[Index]:=Value;
//end;
...
{ TValueChangeEffectAnimator }

constructor TValueChangeEffectAnimator.Create(AOwner: TComponent);
begin
  inherited;

  FValueChangeEffectList:=TValueChangeEffectList.Create();//(Self);

end;

procedure TValueChangeEffectAnimator.AddEffect(AValueChangeEffectIntf:IValueChangeEffect);
var
  AValueChangeEffect:TValueChangeEffect;
begin
  AValueChangeEffect:=TValueChangeEffect.Create();
  AValueChangeEffect.FValueChangeEffectIntf:=AValueChangeEffectIntf;
  FValueChangeEffectList.Add(AValueChangeEffect);
end;

destructor TValueChangeEffectAnimator.Destroy;
begin
  FreeAndNil(FValueChangeEffectList);
  inherited;
end;

procedure TValueChangeEffectAnimator.DoAnimate(Sender: TObject; var NeedStop: Boolean);
var
  I: Integer;
begin
  inherited;
  for I := 0 to FValueChangeEffectList.Count-1 do
  begin
    FValueChangeEffectList[I].DoAnimate(Self);
  end;
end;

procedure TValueChangeEffectAnimator.DoAnimateBegin(Sender: TObject);
var
  I: Integer;
begin
  inherited;
  for I := 0 to FValueChangeEffectList.Count-1 do
  begin
//    if FValueChangeEffectList[I].F then

    FValueChangeEffectList[I].DoAnimateBegin(Self);
  end;
end;

procedure TValueChangeEffectAnimator.DoAnimateEnd(Sender: TObject);
var
  I: Integer;
begin
  inherited;
  for I := 0 to FValueChangeEffectList.Count-1 do
  begin
    FValueChangeEffectList[I].DoAnimateEnd(Self);
  end;

  FValueChangeEffectList.Clear;
end;

//procedure TValueChangeEffectAnimator.SetValueChangeEffectList(const Value: TValueChangeEffectList);
//begin
//  FValueChangeEffectList.Assign(Value);
//end;
