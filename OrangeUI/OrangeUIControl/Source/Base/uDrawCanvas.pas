...
type
  ...
  public
    ...
    ///   </para>
    /// </summary>
    function DrawPathData(ADrawPathData:TBaseDrawPathData;const ADrawRect:TRectF;APathActions:TPathActionCollection):Boolean;virtual;
    function FillPathData(ADrawPathParam:TDrawPathParam;ADrawPathData:TBaseDrawPathData;const ADrawRect:TRectF;APathActions:TPathActionCollection):Boolean;virtual;
  ...
  //背景绘制框
  TDrawRectParamPaintStyle=class
  public
    //自定义绘制方法
    function CustomPaint(ACanvas:TObject;ADrawParam:TDrawRectParam;ASkinMaterial:TObject;const ADrawRect:TRectF;APaintData:TPaintData):Boolean;virtual;abstract;
  end;
  TDrawRectParamPaintStyleClass=class of TDrawRectParamPaintStyle;

  TDrawRectParamPaintStyleRegItem=class
  public
    //样式名称
    Name:String;
    StyleClass:TDrawRectParamPaintStyleClass;
  end;
  TDrawRectParamPaintStyleRegList=class(TBaseList)
  public
    procedure Add(AName:String;AStyleClass:TDrawRectParamPaintStyleClass);overload;
  end;

  //样式1
  TDrawRectParamPaintStyle_01=class(TDrawRectParamPaintStyle)
  public
    //自定义绘制方法
    function CustomPaint(ACanvas:TObject;ADrawParam:TDrawRectParam;ASkinMaterial:TObject;const ADrawRect:TRectF;APaintData:TPaintData):Boolean;override;
  end;
...
var
  ...
  GlobalDrawRectParamPaintStyleRegList:TDrawRectParamPaintStyleRegList;
...
function TDrawCanvas.FillPathData(ADrawPathParam:TDrawPathParam;ADrawPathData: TBaseDrawPathData;const ADrawRect:TRectF;APathActions:TPathActionCollection): Boolean;
begin
  Result:=True;
end;
...
var
  ...
  ARect:TRectF;
begin
  APathActions.FDrawPathData.Prepare(Self);
...
function TDrawCanvas.DrawPathData(ADrawPathData: TBaseDrawPathData;const ADrawRect:TRectF;APathActions:TPathActionCollection):Boolean;
begin
  Result:=True;
end;
...
{ TDrawRectParamPaintStyle_01 }

function TDrawRectParamPaintStyle_01.CustomPaint(ACanvas: TObject;
  ADrawParam: TDrawRectParam; ASkinMaterial: TObject; const ADrawRect: TRectF;
...
{ TDrawRectParamPaintStyleRegList }

procedure TDrawRectParamPaintStyleRegList.Add(AName: String;
  AStyleClass: TDrawRectParamPaintStyleClass);
var
  ARegItem:TDrawRectParamPaintStyleRegItem;
begin
  ARegItem:=TDrawRectParamPaintStyleRegItem.Create;
  ARegItem.Name:=AName;
  ARegItem.StyleClass:=AStyleClass;
  Inherited Add(ARegItem);
...
//  GlobalCanvasNameList:=TList.Create;
  ...
  GlobalDrawRectParamPaintStyleRegList:=TDrawRectParamPaintStyleRegList.Create;


finalization
//  FreeAndNil(GlobalCanvasNameList);

  FreeAndNil(GlobalDrawRectParamPaintStyleRegList);
