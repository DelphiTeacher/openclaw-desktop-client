...
initialization
  RegisterClasses([TSkinRegExTagLabelView]);
  //开关条
  RegisterSkinControlStyle('SkinRegExTagLabelView',TSkinRegExTagLabelViewDefaultType,TSkinRegExTagLabelViewDefaultMaterial,TRegExTagLabelViewProperties,Const_Default_ComponentType,True);
