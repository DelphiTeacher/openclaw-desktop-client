...
//  {$IFDEF FMX}
//  TSkinFMXItemDesignerPanel=class;
//  {$ENDIF}
...
//                                      AItemDrawRect:TRect) of object;
  ...
  TOnCalcItemSizeEvent=procedure(Sender:TObject;
                                      AItem:TSkinItem;
                                      AItemDrawRect:TRectF;
                                      var AItemSize:TSizeF) of object;
  ...
  ['{C3B7ECD3-960E-4BF7-8AF8-19AE695DD3E7}']
    function GetOnCalcItemSize:TOnCalcItemSizeEvent;
    ...
    property OnCalcItemSize:TOnCalcItemSizeEvent read GetOnCalcItemSize;
...
//    FFieldName:String;
    ...
    FProcessItemColorIntf: IProcessItemColor;
  end;
  TItemBindingControlList=class(TBaseList)
  private
    function GetItem(Index: Integer): TItemBindingControlItem;
  public
    function FindByBindItemFieldName(AFieldName:String):TItemBindingControlItem;
  ...
  protected
    ...
    FItemIconColorIntf: IProcessItemColor;
    FItemPicColorIntf: IProcessItemColor;
  protected
  ...
  public
    ...
    //处理列表项的颜色
    procedure ProcessItemBindingControlColor(AItemColorType:TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType;AItemColor:TDelphiColor;var AOldColor:TDelphiColor);
    //恢复列表项的颜色
    procedure RestoreItemBindingControlColor(AItemColorType:TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType;AItemColor:TDelphiColor;AOldColor:TDelphiColor);
...
//                          ABindingControl:TControl);
    ...
    property ItemAccessoryMoreIntf:IBindSkinItemTextControl read FItemAccessoryMoreIntf;
...
//    EditingSubItemsIndex:Integer;
  ...
  private
    ...
    FOnCalcItemSize:TOnCalcItemSizeEvent;
  ...
  published
    property OnCalcItemSize:TOnCalcItemSizeEvent read GetOnCalcItemSize write FOnCalcItemSize;
...
//  TItemDesignerPanel={$IFDEF VCL}TSkinWinItemDesignerPanel{$ENDIF}{$IFDEF FMX}TSkinFMXItemDesignerPanel{$ENDIF};
//  TItemDesignerPanel=TSkinItemDesignerPanel;//{$IFDEF VCL}TSkinWinItemDesignerPanel{$ENDIF}{$IFDEF FMX}TSkinFMXItemDesignerPanel{$ENDIF};
...
begin
  ...
  //
  //
  //            OffsetRectF(AItemDrawRect,0,Self.FSkinControl.Height+10);
...
//  uBaseLog.HandleException(nil,'TItemDesignerPanelProperties.SetControlsValueByItem Begin');
  ...
  begin
    TControl(Self.ItemAccessoryMoreBindingControl).Visible:=(AItem.Accessory<>satNone);
  end;
...
procedure TItemDesignerPanelProperties.ProcessItemBindingControlColor(AItemColorType: TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType; AItemColor: TDelphiColor;var AOldColor:TDelphiColor);
var
...
begin
  case AItemColorType of
    ...
    begin
      //标题字体颜色
      if Self.FItemCaptionColorIntf<>nil then
      begin
        FItemCaptionColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetailFontColor,sictDetailBackColor:
    begin
      if Self.FItemDetailColorIntf<>nil then
      begin
        FItemDetailColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail1FontColor,sictDetail1BackColor:
    begin
      if Self.FItemDetail1ColorIntf<>nil then
      begin
        FItemDetail1ColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail2FontColor,sictDetail2BackColor:
    begin
      if Self.FItemDetail2ColorIntf<>nil then
      begin
        FItemDetail2ColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail3FontColor,sictDetail3BackColor:
    begin
      if Self.FItemDetail3ColorIntf<>nil then
      begin
        FItemDetail3ColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail4FontColor,sictDetail4BackColor:
    begin
      if Self.FItemDetail4ColorIntf<>nil then
      begin
        FItemDetail4ColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail5FontColor,sictDetail5BackColor:
    begin
      if Self.FItemDetail5ColorIntf<>nil then
      begin
        FItemDetail5ColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail6FontColor,sictDetail6BackColor:
    begin
      if Self.FItemDetail6ColorIntf<>nil then
      begin
        FItemDetail6ColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictIconBackColor:
    begin
      if Self.FItemIconColorIntf<>nil then
      begin
        FItemIconColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictPicBackColor:
    begin
      if Self.FItemPicColorIntf<>nil then
      begin
        FItemPicColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
  end;

  if AItemColorFieldName<>'' then
  begin
    AItemBindingControlItem:=Self.FItemBindingControlList.FindByBindItemFieldName(AItemColorFieldName);
    if (AItemBindingControlItem<>nil) and (AItemBindingControlItem.FProcessItemColorIntf<>nil) then
    begin
      AItemBindingControlItem.FProcessItemColorIntf.ProcessItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
    end;
  end;
...
procedure TItemDesignerPanelProperties.RestoreItemBindingControlColor(AItemColorType: TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType; AItemColor, AOldColor: TDelphiColor);
var
  AItemBindingControlItem:TItemBindingControlItem;
begin
  case AItemColorType of
    ...
    begin
      ...
      if Self.FItemCaptionColorIntf<>nil then
      begin
        FItemCaptionColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetailFontColor,sictDetailBackColor:
    begin
      if Self.FItemDetailColorIntf<>nil then
      begin
        FItemDetailColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail1FontColor,sictDetail1BackColor:
    begin
      if Self.FItemDetail1ColorIntf<>nil then
      begin
        FItemDetail1ColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail2FontColor,sictDetail2BackColor:
    begin
      if Self.FItemDetail2ColorIntf<>nil then
      begin
        FItemDetail2ColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail3FontColor,sictDetail3BackColor:
    begin
      if Self.FItemDetail3ColorIntf<>nil then
      begin
        FItemDetail3ColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail4FontColor,sictDetail4BackColor:
    begin
      if Self.FItemDetail4ColorIntf<>nil then
      begin
        FItemDetail4ColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail5FontColor,sictDetail5BackColor:
    begin
      if Self.FItemDetail5ColorIntf<>nil then
      begin
        FItemDetail5ColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictDetail6FontColor,sictDetail6BackColor:
    begin
      if Self.FItemDetail6ColorIntf<>nil then
      begin
        FItemDetail6ColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictIconBackColor:
    begin
      if Self.FItemIconColorIntf<>nil then
      begin
        FItemIconColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
    sictPicBackColor:
    begin
      if Self.FItemPicColorIntf<>nil then
      begin
        FItemPicColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
        Exit;
      end;
    end;
  end;
  ...
  begin
    ...
    if (AItemBindingControlItem<>nil) and (AItemBindingControlItem.FProcessItemColorIntf<>nil) then
    begin
      AItemBindingControlItem.FProcessItemColorIntf.RestoreItemColor(AItemColorType,AItemColorFieldName,AItemColorFieldSetType,AItemColor,AOldColor);
    end;
  end;
...
begin
  SetBindSkinItemIconControl(Value,
    FItemIconControl,FItemIconIntf,FItemIconColorIntf,FSkinControl,FBindControlInvalidateChange);
end;

procedure TItemDesignerPanelProperties.SetItemPicControl(const Value: TChildControl);
begin
  SetBindSkinItemIconControl(Value,
    FItemPicControl,FItemPicIntf,FItemPicColorIntf,FSkinControl,FBindControlInvalidateChange);
end;
...
//                AItemBindingControl.FFieldName:=AFieldName;
                ...
                //设置颜色的接口
                AChildControl.GetInterface(IID_IProcessItemColor,AItemBindingControl.FProcessItemColorIntf);
...
function TSkinItemDesignerPanel.GetOnCalcItemSize:TOnCalcItemSizeEvent;
begin
  Result := FOnCalcItemSize;
end;
...
{$IFDEF FMX}
procedure TSkinItemDesignerPanel.DoAddObject(const AObject: TFmxObject);
begin
  Inherited;
//  Self.Prop.FIsSyncedSkinItemBindingControls:=False;
end;

procedure TSkinItemDesignerPanel.DoInsertObject(Index: Integer; const AObject: TFmxObject);
begin
  Inherited;
//  Self.Prop.FIsSyncedSkinItemBindingControls:=False;
end;

procedure TSkinItemDesignerPanel.DoRemoveObject(const AObject: TFmxObject);
begin
  Inherited;
//  Self.Prop.FIsSyncedSkinItemBindingControls:=False;
end;
...
function TItemBindingControlList.FindByBindItemFieldName(
  AFieldName: String): TItemBindingControlItem;
var
  I: Integer;
begin
  Result:=nil;
  ...
  begin
    if Items[I].FSkinItemBindingControlIntf.GetBindItemFieldName=AFieldName then
    begin
      Result:=Items[I];
      Break;
    end;
