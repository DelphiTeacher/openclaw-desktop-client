...
//    property DrawNotifyRectParam:TDrawRectParam read FDrawNotifyRectParam write SetDrawNotifyRectParam;
//  end;
  TSkinNotifyNumberIconColorMaterial=class(TSkinNotifyNumberIconDefaultMaterial)
...
begin
  Result:=Not Self.GetSkinMaterial.FNotifyPicture.IsEmpty or Self.GetSkinMaterial.FDrawNotifyRectParam.IsFill;
end;
...
procedure TSkinNotifyNumberIconDefaultMaterial.SetDrawNotifyRectParam(const Value: TDrawRectParam);
begin
...
//  RegisterSkinControlStyle('SkinNotifyNumberIcon',TSkinNotifyNumberIconColorType,TSkinNotifyNumberIconColorMaterial,TNotifyNumberIconProperties,'Color',False);
  RegisterSkinControlStyle('SkinNotifyNumberIcon',TSkinNotifyNumberIconDefaultType,TSkinNotifyNumberIconColorMaterial,TNotifyNumberIconProperties,'ColorTest',False);
  RegisterSkinControlStyle('SkinNotifyNumberIcon',TSkinNotifyNumberIconDefaultType,TSkinNotifyNumberIconDefaultMaterial,TNotifyNumberIconProperties,'Color',False);
