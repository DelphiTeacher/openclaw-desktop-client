...
type
  ...
  TSkinComboBoxViewType=(scbvtText,scbvtEdit,scbvtListView);
...
//    function GetCurrentEffectStates(APaintData:TPaintData): TDPEffectStates;override;
  ...
  {$I ComponentPlatformsAttribute.inc}
  TSkinCustomComboBox=class(TBaseSkinControl,
                        ISkinComboBox,
...
//    procedure SetDetail1(const Value:String);
    ...
    procedure DolvMultiSelectedItemsClickItemDesignerPanelChild(Sender:TObject;
                                                                ...
                                                                AChild:{$IFDEF FMX}TFmxObject{$ELSE}TChildControl{$ENDIF});
...
//    property Text;
  ...
  {$IFDEF VCL}
  TSkinComboBox=class(TSkinCustomComboBox)
  end;
  {$ENDIF}
...
function TSkinCustomComboBox.GetPopupFormWidth: Integer;
begin
  Result:=Ceil(Width);
...
//function TSkinCustomComboBox.GetText: String;
//begin
////  Result:=False;
//end;

function TSkinCustomComboBox.GetSelectedCaptions: String;
var
  I:Integer;
...
function TSkinCustomComboBox.GetSelectedNames: String;
var
  I:Integer;
  ASelectedList:TStringList;
  AEditText:string;
...
//function TSkinCustomComboBox.GetSelectedTextArray: ISuperArray;
//var
//  I:Integer;
//  ASelectedList:TStringList;
//  AEditText:string;
...
function TSkinCustomComboBox.GetViewType: TSkinComboBoxViewType;
begin
  Result:=FViewType;
end;

function TSkinCustomComboBox.IsItemCanAddToText(AItem: TSkinItem): Boolean;
begin
  Result:=True;
end;

////获取已选内容下标数组
//function TSkinCustomComboBox.GetSelectedIndexArray: ISuperArray;
//var
//  I:Integer;
//  ASelectedList:TStringList;
//  AEditText:string;
...
//procedure TSkinCustomComboBox.lvMultiSelectedItemsNewListItemStyleFrameCacheInit(
...
procedure TSkinCustomComboBox.lvPopupItemsClickItem(AItem: TSkinItem);
var
  I:Integer;
  AText:String;
begin
...
//procedure TSkinCustomComboBox.lvPopupItemsNewListItemStyleFrameCacheInit(Sender: TObject;
//  AListItemTypeStyleSetting: TListItemTypeStyleSetting;
//  ANewListItemStyleFrameCache: TListItemStyleFrameCache);
////var
...
//end;
//
//procedure TSkinCustomComboBox.lvPopupItemsPrepareDrawItem(Sender: TObject;
...
procedure TSkinCustomComboBox.SetText(const Value: String);
begin
...
procedure TSkinCustomComboBox.SetViewType(const Value: TSkinComboBoxViewType);
begin
...
procedure TSkinCustomComboBox.SyncMultiSelectedItems;
var
  I:Integer;
  AEditText:String;
  ASkinItem:TSkinItem;
...
function TSkinCustomComboBox.CreateSelectPopupForm: TfrmSkinSelectPopup;
begin
  Result:=uSkinSelectPopupForm.CreateSkinSelectPopupForm(Self,TfrmSkinSelectPopup);
end;


//function TSkinCustomComboBox.GetSelected: Boolean;
//begin
//  Result:=False;
//end;
//
//function TSkinCustomComboBox.GetThisRowItemCount: Integer;
//begin
//  Result:=0;
//end;
//
////层级
//function TSkinCustomComboBox.GetLevel:Integer;
//begin
//  Result:=0;
//end;
//
////获取与设置自定义属性
//function TSkinCustomComboBox.GetPropJsonStr:String;
//begin
//  Result:=Inherited;
//end;
//
//procedure TSkinCustomComboBox.SetPropJsonStr(AJsonStr:String);
//var
...
//
//
//function TSkinCustomComboBox.LoadFromFieldControlSetting(ASetting: TFieldControlSetting;AFieldControlSettingMap:TObject): Boolean;
//begin
//  Setting:=ASetting;
...
//end;
//
//procedure TSkinCustomComboBox.SetItemDrawRect(Value: TRectF);
//begin
//  FItemDrawRect:=Value;
//end;
//
//function TSkinCustomComboBox.GetIsRowEnd:Boolean;
//begin
//  Result:=False;
//end;
//
//procedure TSkinCustomComboBox.SetSkinListIntf(ASkinListIntf: ISkinList);
//begin
//  FSkinListIntf:=ASkinListIntf;
//end;
//
//procedure TSkinCustomComboBox.TranslateControlLang(APrefix: String; ALang: TLang;
//  ACurLang: String);
//begin
//  inherited;
//
...
//end;
//
//function TSkinCustomComboBox.GetListLayoutsManager:TSkinListLayoutsManager;
//begin
//  Result:=FSkinListIntf.GetListLayoutsManager;
//end;
//
//procedure TSkinCustomComboBox.ClearItemRect;
//begin
//
//end;
//
//procedure TSkinCustomComboBox.SetItemRect(Value: TRectF);
//begin
//  FItemRect:=Value;
//  Self.SetBounds(Value);
//end;
//
//function TSkinCustomComboBox.GetItemDrawRect: TRectF;
//begin
//  Result:=FItemDrawRect;
//end;
//
//function TSkinCustomComboBox.GetItemRect: TRectF;
//begin
//  Result:=FItemRect;
//end;
//
//
//function TSkinCustomComboBox.GetObject: TObject;
//begin
//  Result:=Self;
//end;
//
//function TSkinCustomComboBox.GetWidth:Double;
//begin
//  Result:=Width;
//end;
//
//function TSkinCustomComboBox.GetHeight:Double;
//begin
//  Result:=Height;
//end;

function TSkinCustomComboBox.Material:TSkinComboBoxDefaultMaterial;
begin
  Result:=TSkinComboBoxDefaultMaterial(SelfOwnMaterial);
end;

//function TSkinCustomComboBox.PtInItem(APoint: TPointF): Boolean;
//begin
//  Result:=PtInRect(Self.FItemDrawRect,APoint);
//
//end;

procedure TSkinCustomComboBox.Click;
var
  APopupPoint:TPoint;
  APopupPointF:TPointF;
begin
  Inherited;
  ...
  begin
    ...
    {$IFDEF FMX}
    //当它在设计面板中的时候就不能这么计算
    APopupPointF:=Self.LocalToScreen(PointF(0,Self.Height));
    APopupPoint:=Point(Ceil(APopupPointF.X),Ceil(APopupPointF.Y));
    {$ENDIF}
...
constructor TSkinCustomComboBox.Create(AOwner: TComponent);
begin
  inherited;
...
//  lvMultiSelectedItems.Material.DrawItemBackColorParam.DrawEffectSetting.MouseOverEffect.Eff
  ...
  {$ENDIF}
  {$IFDEF FMX}
  lvMultiSelectedItems.Margins.Left:=2;
  lvMultiSelectedItems.Margins.Top:=2;
  lvMultiSelectedItems.Margins.Right:=2;
  lvMultiSelectedItems.Margins.Bottom:=2;
...
function TSkinCustomComboBox.CurrentUseMaterialToDefault:TSkinComboBoxDefaultMaterial;
begin
  Result:=TSkinComboBoxDefaultMaterial(CurrentUseMaterial);
end;

function TSkinCustomComboBox.SelfOwnMaterialToDefault:TSkinComboBoxDefaultMaterial;
begin
  Result:=TSkinComboBoxDefaultMaterial(SelfOwnMaterial);
end;

function TSkinCustomComboBox.GetPropertiesClassType: TPropertiesClassType;
begin
  Result:=TComboBoxProperties;
end;

//procedure TSkinCustomComboBox.ReadState(Reader: TReader);
//var
...
//end;
//
//procedure TSkinCustomComboBox.RecordControlLangIndex(APrefix: String; ALang: TLang;
//  ACurLang: String);
//begin
//  inherited;
//
...
destructor TSkinCustomComboBox.Destroy;
begin
...
procedure TSkinCustomComboBox.DolvMultiSelectedItemsClickItemDesignerPanelChild(
  Sender: TObject; AItem: TBaseSkinItem;
  AItemDesignerPanel: {$IFDEF FMX}TSkinFMXItemDesignerPanel{$ELSE}TSkinItemDesignerPanel{$ENDIF}; AChild: {$IFDEF FMX}TFmxObject{$ELSE}TChildControl{$ENDIF});
var
  I: Integer;
  ASelectedList:TStringList;
begin
...
procedure TSkinCustomComboBox.DropDown(APopupPoint:TPoint);
var
...
//                                    200);
  ...
  {$ENDIF}
  {$IFDEF FMX}
  lvPopupItems.Align:=TAlignLayout.Client;
  {$ENDIF}
...
//    ACompanySizeArray:=TSuperArray.Create('["1-10人","11-50人","51-200人","201-500人","501-1000人","1001-5000人","5001-10000人","超过10001人"]');
  ...
  FfrmSelectPopup.Popup(APopupPoint,
                        GetPopupFormWidth,
                        //200
                        Ceil(ScreenScaleSize(ADropDownCount*Self.lvPopupItems.Prop.ItemHeight))
                        );


end;

function TSkinCustomComboBox.EditGetValue: Variant;
begin
  Result:=Text;
end;

procedure TSkinCustomComboBox.EditMouseDown(Button: TMouseButton; Shift: TShiftState;
  X, Y: Double);
begin

end;

procedure TSkinCustomComboBox.EditMouseMove(Shift: TShiftState; X, Y: Double);
begin

end;

procedure TSkinCustomComboBox.EditMouseUp(Button: TMouseButton; Shift: TShiftState; X,
  Y: Double);
begin

end;

procedure TSkinCustomComboBox.EditSetValue(const AValue: Variant);
begin
  Text:=AValue;
end;

function TSkinCustomComboBox.GetComboBoxProperties: TComboBoxProperties;
begin
  Result:=TComboBoxProperties(Self.FProperties);
end;

function TSkinCustomComboBox.GetIsDropedDown: Boolean;
begin
  Result:=False;
...
function TSkinCustomComboBox.GetlvMultiSelectedItemsOnNewListItemStyleFrameCacheInit: TNewListItemStyleFrameCacheInitEvent;
begin
  Result:=Self.lvMultiSelectedItems.OnNewListItemStyleFrameCacheInit;
end;

function TSkinCustomComboBox.GetOnlvPopupItemsNewListItemStyleFrameCacheInit: TNewListItemStyleFrameCacheInitEvent;
begin
  Result:=Self.lvPopupItems.OnNewListItemStyleFrameCacheInit;
end;

procedure TSkinCustomComboBox.SetComboBoxProperties(Value: TComboBoxProperties);
begin
  Self.FProperties.Assign(Value);
end;

procedure TSkinCustomComboBox.SetItemIndex(const Value: Integer);
begin
...
procedure TSkinCustomComboBox.SetItems(const Value: TStringList);
begin
  FItems.Assign(Value);
end;

procedure TSkinCustomComboBox.SetlvPopupItemsOnNewListItemStyleFrameCacheInit(
  const Value: TNewListItemStyleFrameCacheInitEvent);
begin
  Self.lvPopupItems.OnNewListItemStyleFrameCacheInit:=Value;
end;

procedure TSkinCustomComboBox.SetOnlvMultiSelectedItemsNewListItemStyleFrameCacheInit(
  const Value: TNewListItemStyleFrameCacheInitEvent);
begin
  Self.lvMultiSelectedItems.OnNewListItemStyleFrameCacheInit:=Value;
end;

procedure TSkinCustomComboBox.SetControlValueByBindItemField(
...
//procedure TSkinCustomComboBox.SetControlObjectByBindItemField(const AFieldName: String;
...
//end;
//
//procedure TSkinCustomComboBox.SetDetail(const Value:String);
//begin
...
//end;
//
//procedure TSkinCustomComboBox.SetDetail1(const Value:String);
//begin
...
//end;
//
//function TSkinCustomComboBox.GetDetail:String;
//begin
//  Result:=FDetail;
//end;
//
//function TSkinCustomComboBox.GetDetail1:String;
//begin
//  Result:=FDetail1;
//end;
//
//procedure TSkinCustomComboBox.DoCustomSkinMaterialChange(Sender: TObject);
//begin
//  //自动设置尺寸
...
procedure TSkinCustomComboBox.BindingItemText(const AName:String;const AText:String;ASkinItem:TObject;AIsDrawItemInteractiveState:Boolean);
begin
  //为什么要Caption,
//  StaticCaption:=AText;
...
//function TSkinCustomComboBox.GetPostValue(ASetting:TFieldControlSetting;APageDataDir:String;ASetRecordFieldValueIntf:ISetRecordFieldValue;
...
//end;
//
//procedure TSkinCustomComboBox.SetControlValue(ASetting:TFieldControlSetting;APageDataDir:String;AImageServerUrl:String;AValue:Variant;AValueCaption:String;
//                            //要设置多个值,整个字段的记录
...
initialization
  ...
  RegisterClasses([TSkinCustomComboBox]);
  {$IFDEF VCL}
