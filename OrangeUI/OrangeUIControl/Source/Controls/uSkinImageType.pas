  ...
  begin
      ...
      begin
        ...
        TSkinBaseGIFPictureEngine(Self.FSkinImageIntf.Prop.Picture.SkinPictureEngine).DrawToCanvas(ACanvas,
                                  TSkinImageMaterial(ASkinMaterial).FDrawPictureParam,
                                  ADrawRect);
//        TDrawCanvas(ACanvas).DrawSkinPicture(TSkinImageMaterial(ASkinMaterial).FDrawPictureParam,TSkinBaseGIFPictureEngine(Self.FSkinImageIntf.Prop.Picture.SkinPictureEngine).CurrentAnimateFrame,ADrawRect,False,RectF(0,0,0,0),RectF(0,0,0,0));
      end
      else
      begin

        //图片旋转
        TSkinImageMaterial(ASkinMaterial).FDrawPictureParam.StaticRotateAngle:=Self.FSkinImageIntf.Prop.FCurrentRotateAngle;

        //Lazarus下面会报错
        ACanvas.DrawPicture(TSkinImageMaterial(ASkinMaterial).FDrawPictureParam,
      ...
      begin
        ACanvas.DrawText(TSkinImageMaterial(ASkinMaterial).FDrawCaptionParam,
...
procedure TSkinImage.ProcessItemColor(AItemColorType:TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType;AItemColor:TDelphiColor;var AOldColor:TDelphiColor);
begin
...
procedure TSkinImage.RestoreItemColor(AItemColorType:TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType;AItemColor:TDelphiColor;AOldColor:TDelphiColor);
begin
  case AItemColorType of
    sictNone: ;
    sictBackColor:
