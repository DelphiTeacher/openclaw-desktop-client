...
//    FIsAutoSwitchPageAnimating:Boolean;
    ...
    //头部区域
    function GetHeaderRect(ADrawRect:TRectF): TRectF;
    //头部放置页面按钮的区域
    function GetDrawTabButtonsHeaderRect(ADrawRect:TRectF): TRectF;
  ...
  protected
    ...
    procedure DoPageDelete(Sender:TObject;AItem:TObject);
...
//    procedure SortPages;
    ...
    //获取分页按钮的绘制矩形
    function GetVisibleTabDrawRect(ADrawRect:TRectF;VisibleIndex:Integer):TRectF;
...
//    end;
    ...
    begin
          ...
          ATabDrawRect:=Self.FSkinPageControlIntf.PageControlProperties.GetVisibleTabDrawRect(ADrawRect,I);
...
//    end;
    ...
    ACanvas.DrawRect(Self.GetSkinMaterial.FDrawTabHeaderColorParam,
                        Self.FSkinPageControlIntf.PageControlProperties.GetHeaderRect(ADrawRect));
...
procedure TPageControlProperties.DoPageDelete(Sender:TObject;AItem:TObject);
begin
...
function TPageControlProperties.GetDrawTabButtonsHeaderRect(ADrawRect:TRectF): TRectF;
begin
  Result:=GetHeaderRect(ADrawRect);
...
function TPageControlProperties.GetHeaderRect(ADrawRect:TRectF): TRectF;
var
  ATabHeaderHeight:Double;
begin
  Result:=ADrawRect;//RectF(0,0,Self.FSkinControlIntf.Width,Self.FSkinControlIntf.Height);
...
function TPageControlProperties.GetVisibleTabDrawRect(ADrawRect:TRectF;VisibleIndex: Integer): TRectF;
      ...
      Begin
        ...
        case Self.FTabSizeCalcType of
          ...
          begin
              case Self.FOrientation of
                toNone: ;
                toLeft: Result:=RectHeightF(GetHeaderRect(ADrawRect));
                toTop: Result:=RectWidthF(GetHeaderRect(ADrawRect));
                toRight: Result:=RectHeightF(GetHeaderRect(ADrawRect));
                toBottom: Result:=RectWidthF(GetHeaderRect(ADrawRect));
              end;
          end;
          tsctFixed:
          begin
...
begin
  ...
  Result:=GetDrawTabButtonsHeaderRect(ADrawRect);
//  Result.Left:=ADrawRect.Left+Result.Left;
//  Result.Top:=ADrawRect.Top+Result.Top;
//  Result.Right:=ADrawRect.Left+Result.Right;
//  Result.Bottom:=ADrawRect.Top+Result.Bottom;
...
//    tsctCustom: ;
  ...
  begin
    case Self.FOrientation of
      toNone: ;
      toLeft: OffsetRectF(Result,0,(RectHeightF(GetHeaderRect(ADrawRect))-GetTabHeaderSize)/2);
      toTop: OffsetRectF(Result,(RectWidthF(GetHeaderRect(ADrawRect))-GetTabHeaderSize)/2,0);
      toRight: OffsetRectF(Result,0,(RectHeightF(GetHeaderRect(ADrawRect))-GetTabHeaderSize)/2);
      toBottom: OffsetRectF(Result,(RectWidthF(GetHeaderRect(ADrawRect))-GetTabHeaderSize)/2,0);
    end;
  end;
...
begin
  ...
  for I := 0 to Self.FVisiblePages.Count-1 do
  begin
    if PtInRectF(Self.GetVisibleTabDrawRect(ADrawRect,I),PointF(X,Y)) then
    begin
