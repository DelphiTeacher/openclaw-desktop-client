...
begin
  ...
  begin
      ...
      begin
        ...
        CornerSize.cx:=FRoundWidth;
        CornerSize.cy:=FRoundHeight;
...
initialization
  RegisterClasses([TSkinCalloutRect]);

  //按钮
  RegisterSkinControlStyle('SkinCalloutRect',TSkinCalloutRectDefaultType,TSkinCalloutRectDefaultMaterial,TCalloutRectProperties,Const_Default_ComponentType,True);
end.
