...
//  begin
    ...
    if PtInRectF(RectF(0,0,Self.FSkinControlIntf.Width,Self.FSkinControlIntf.Height),FMouseMovePt) then
    begin
      PtInBarRect:=True;
      PtInTrackBtnRect:=PtInRectF(Self.GetTrackBtnDrawRect,FMouseMovePt);
    end;
...
begin
  ...
  begin
    ...
    OffsetRectF(AUpSpaceDrawRect,ADrawRect.Left,ADrawRect.Top);
    ...
    OffsetRectF(ATrackBtnRect,ADrawRect.Left,ADrawRect.Top);
...
procedure TSkinTrackBarDefaultMaterial.SetHorzProgressNormalPicture(const Value: TDrawPicture);
begin
  FHorzProgressNormalPicture.Assign(Value);
end;

procedure TSkinTrackBarDefaultMaterial.SetVertProgressNormalPicture(const Value: TDrawPicture);
begin
...
//        OffsetRectF(AProgressDrawRect,ADrawRect.Left,ADrawRect.Top);
