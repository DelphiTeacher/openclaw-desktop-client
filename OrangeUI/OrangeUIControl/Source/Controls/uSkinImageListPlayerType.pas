...
//              TDrawCanvas(ACanvas).DrawSkinPicture(Self.GetSkinMaterial.FDrawPictureParam,TSkinBaseGIFPictureEngine(ABeforePicture.SkinPictureEngine).CurrentAnimateFrame,ABeforePictureDrawRect,False,RectF(0,0,0,0),RectF(0,0,0,0));
            end
            else
            begin
...
//            TDrawCanvas(ACanvas).DrawSkinPicture(Self.GetSkinMaterial.FDrawPictureParam,TSkinBaseGIFPictureEngine(AAfterPicture.SkinPictureEngine).CurrentAnimateFrame,AAfterPictureDrawRect,False,RectF(0,0,0,0),RectF(0,0,0,0));
          end
          else
          begin
            ACanvas.DrawPicture(Self.GetSkinMaterial.FDrawPictureParam,
    ...
    begin
        ...
        begin
          ...
          TSkinBaseGIFPictureEngine(Self.FSkinImageListPlayerIntf.Prop.Picture.SkinPictureEngine).DrawToCanvas(ACanvas,
                                          Self.GetSkinMaterial.FDrawPictureParam,
                                          ADrawRect);
//          TDrawCanvas(ACanvas).DrawSkinPicture(Self.GetSkinMaterial.FDrawPictureParam,TSkinBaseGIFPictureEngine(Self.FSkinImageListPlayerIntf.Prop.Picture.SkinPictureEngine).CurrentAnimateFrame,ADrawRect,False,RectF(0,0,0,0),RectF(0,0,0,0));
        end
        else
        begin
