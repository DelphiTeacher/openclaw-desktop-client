...
//  uSkinCustomListType,
  ...
  {$IFDEF ColumnHeaderIsControl}
  uSkinColumnHeaderType,
  {$ENDIF}
...
//                                      ACellDrawRect:TRect) of object;
  //点击设计面板上面子控件的事件
  TVirtualGridClickCellItemDesignerPanelChildEvent=procedure(Sender:TObject;
                                        ARow:TBaseSkinItem;//这里应该用TBaseSkinItem
                                        AColumn:TSkinVirtualGridColumn;
                                        AItemDesignerPanel:TSkinItemDesignerPanel;
  ...
  ISkinVirtualGrid=interface//(ISkinScrollControl)
    ...
    function GetOnClickCellItemDesignerPanelChild:TVirtualGridClickCellItemDesignerPanelChildEvent;
...
//    procedure SyncColumnHeader;
    ...
    property OnClickCellItemDesignerPanelChild:TVirtualGridClickCellItemDesignerPanelChildEvent read GetOnClickCellItemDesignerPanelChild;
...
//    FItemDrawRect:TRectF;
    ...
    { #todo : 真奇怪  }
    FAutoFitWidth:Integer;//如果用double，在Lazarus会报flt overflow，真奇怪
...
//    procedure UnUseCurrentUseMaterial;
  ...
  protected
    ...
    procedure DoNewListItemStyleFrameCacheChangeItem(Sender:TObject;AListItemTypeStyleSetting:TListItemTypeStyleSetting;ANewListItemStyleFrameCache:TListItemStyleFrameCache);
  public
...
//    FBindItemFieldName1:String;
    function GetBindItemFieldName: String;virtual;abstract;
    function GetBindItemFieldName1: String;virtual;abstract;

    procedure SetBindItemFieldName(const Value: String);virtual;abstract;
    procedure SetBindItemFieldName1(const Value: String);virtual;abstract;
  public
...
//    property MaterialUseKind:TMaterialUseKind read FMaterialUseKind write SetMaterialUseKind;
  ...
  TSkinGridColumnsState = (csDefault, csCustomized);
...
//    procedure EndUpdate(AIsForce:Boolean=False);//override;
  ...
  public
    procedure RebuildColumns;virtual;
    //
    function GetState: TSkinGridColumnsState;
    procedure SetState(NewState: TSkinGridColumnsState);
  public
    //创建列表项
  ...
  public
    ...
    function Add: TSkinVirtualGridColumn;
    //AProperties控件设计器需要
    //constructor Create(AProperties:TVirtualGridProperties;
    //                    ItemClass: TCollectionItemClass);virtual;
    destructor Destroy;override;
  public
    property State: TSkinGridColumnsState read GetState write SetState;
    //表格列
...
//  TSkinDBGridOptions = set of TSkinGridOption;
  ...
  public
    ...
    //用于自定义下拉加载面板的上边距
    function GetContentMarginsTop:Double;override;
    function GetContentMarginsBottom:Double;override;
...
//  TSkinVirtualGridColumnMaterial=class(TSkinControlMaterial)
  TSkinVirtualGridColumnMaterial=class(TSkinListItemMaterial)
  private
    //表格列标题绘制参数
//    FDrawCaptionParam:TDrawTextParam;
    ...
    FDrawCellBackColorParam:TDrawRectParam;
    FDrawFooterCellBackColorParam:TDrawRectParam;
    ...
    //单元格的背景色
    function GetBackColor: TDrawRectParam;
    procedure SetBackColor(const Value: TDrawRectParam);
    procedure SetDrawCellBackColorParam(const Value: TDrawRectParam);
    procedure SetDrawFooterCellBackColorParam(const Value: TDrawRectParam);
  public
    constructor Create(AOwner:TComponent);override;
    destructor Destroy;override;
  published
    ...
    //表格列标题绘制参数
    property BackColor:TDrawRectParam read GetBackColor write SetBackColor;
    property DrawCellBackColorParam:TDrawRectParam read FDrawCellBackColorParam write SetDrawCellBackColorParam;
    property DrawFooterCellBackColorParam:TDrawRectParam read FDrawFooterCellBackColorParam write SetDrawFooterCellBackColorParam;
    //表格列标题绘制参数
  ...
  protected
    ...
    FColumnHeaderMaterial:TSkinColumnHeaderDefaultMaterial;
  ...
  private
    ...
    procedure SetColumnHeaderMaterial(
      const Value: TSkinColumnHeaderDefaultMaterial);
  protected
    //从文档节点中加载
    function LoadFromDocNode(ADocNode:TBTNode20_Class):Boolean;override;
    //保存到文档节点
...
//                  AIsDrawBorder:Boolean);
  ...
  published
    ...
    property ColumnHeaderMaterial:TSkinColumnHeaderDefaultMaterial read FColumnHeaderMaterial write SetColumnHeaderMaterial;
...
//                                      ADrawColumnEndIndex:Integer;
  ...
  private
    ...
    FOnCustomPaintCellBegin:TGridCustomPaintCellBeginEvent;
    FOnCustomPaintCellEnd:TGridCustomPaintCellBeginEvent;
    FOnClickCellItemDesignerPanelChild:TVirtualGridClickCellItemDesignerPanelChildEvent;
    ...
    function GetColumnHeader: TSkinColumnHeader;
    {$ENDIF}
//    function GetColumnHeaderMaterial: TSkinColumnHeaderDefaultMaterial;
//
//    procedure DoClickGridHeaderClickItem(AItem:TBaseSkinItem);
  ...
  public
    ...
    {$IFDEF ColumnHeaderIsControl}
    //如果这个放published，设计时经常会报错，不知道为啥{ TODO : 放published中设计时经常报错 }
//    //表头,如果变成published，在Lazarus中使用时加载Columns会报错
    property ColumnHeader:TSkinColumnHeader read GetColumnHeader;// write SetColumnHeader;
    {$ENDIF}
  published
    //属性(必须在VertScrollBar和HorzScrollBar之前)
    property Properties:TVirtualGridProperties read GetVirtualGridProperties write SetVirtualGridProperties;

//    property ColumnHeaderMaterial:TSkinColumnHeaderDefaultMaterial read GetColumnHeaderMaterial;// write SetColumnHeader;
//    property ColumnHeader:TSkinColumnHeader read GetColumnHeader;
    ...
    property OnClickCellItemDesignerPanelChild:TVirtualGridClickCellItemDesignerPanelChildEvent read GetOnClickCellItemDesignerPanelChild write FOnClickCellItemDesignerPanelChild;
...
begin
  //如果有自适应尺寸的列
//  uBaseLog.HandleException(nil,'TVirtualListProperties.SetColumnsAutoFitControlWidth Begin');

  if csLoading in Self.FSkinControl.ComponentState then Exit;
...
//
//          if AColumn.IsUseDefaultGridColumnMaterial
//            and AColumn.IsUseDefaultGridColumnCaptionParam then
//          begin
//            ADrawTextParam:=
...
//          else
//          begin
//            ADrawTextParam:=AColumn.FDrawCellTextParam;
//          end;
      ...
      begin
          ...
          begin
            ...
            if AColumn.IsUseDefaultGridColumnMaterial
              //and AColumn.IsUseDefaultGridColumnCaptionParam
              then
            begin
              ADrawTextParam:=
                TSkinVirtualGridDefaultMaterial(Self.FSkinControlIntf.GetCurrentUseMaterial)
            ...
            begin
              ADrawTextParam:=AColumn.GetCurrentUseMaterial.FDrawCellTextParam;
            end;

            if AColumn.AutoSize then
            begin
    //          AColumnRect:=RectF(0,0,);
          ...
          //            AContentWidth:=Ceil(GetStringWidth(AContent,ADrawTextParam));
                      AContentWidth:=Ceil(GetStringWidth(AContent,ADrawTextParam.FontSize));
                      ARowHeight:=ItemHeight;
                      if ADrawTextParam.DrawRectSetting.Enabled then
                      begin
                        ARowHeight:=ARowHeight-ADrawTextParam.DrawRectSetting.Top-ADrawTextParam.DrawRectSetting.Bottom;
                      end;
                      ...
                      begin
                          ...
                          AContentHeight:=Ceil(GetStringHeight(AContent,ADrawTextParam.FontSize));
                          //有行间距
//                          AContentHeight:=AContentHeight+3;

                          if AContentHeight>0 then
                          begin
                            //单行,或者行高只能显示单行
                            if not ADrawTextParam.IsWordWrap or (ARowHeight/AContentHeight<2) then
                            begin
                            end
                            else
                            //可以多行
                            begin
                              AContentWidth:=ControlSize(AContentWidth/Floor((ARowHeight/AContentHeight)));
                            end;
                          end;
                      ...
                      begin
                        ...
                        if ADrawTextParam.DrawRectSetting.Enabled then
                        begin
                          AColumn.FCalcedAutoSizeWidth:=ControlSize(AColumn.FCalcedAutoSizeWidth
      ...
      begin
        ...
        if AColumn.AutoSize then
        begin
          AColumn.FWidth:=AColumn.FCalcedAutoSizeWidth;
        end;
      end;
  finally
    Self.Columns.EndUpdate;
...
//  uBaseLog.HandleException(nil,'TVirtualListProperties.CalcAutoSizeColumnWidth End');
end;
...
begin
  ...
  begin
    //那么需要空出一行,用于编辑,或隔离统计行
    Result:=ScreenScaleSize(Result+ItemHeight);
  end;
  {$ENDIF}
...
//      FFixedCols:=0;
      ...
      {$IFDEF ColumnHeaderIsControl}
      FColumnHeader:=TSkinColumnHeader.Create(Self.FSkinControl);
...
//      AddFreeNotification(FColumnHeader,Self);
      ...
      FColumnHeader.Parent:=TParentControl(Self.FSkinControl);
      FColumnHeader.Height:=Const_DefaultColumnHeaderHeight;//Ceil(Self.Prop.ColumnsHeaderHeight);
    ...
    //  FColumnHeader.Prop.FVertControlGestureManager:=Self.Prop.FVertControlGestureManager;
      ...
      FColumnHeader.Prop.FHorzControlGestureManager:=Self.FHorzControlGestureManager;
      FColumnHeader.Prop.FIsRefHorzControlGestureManager:=True;

      //允许拖拽列来改变顺序
      FColumnHeader.Prop.FEnableAutoDragDropItem:=False;//True;
      //允许拖动来改变宽度
      FColumnHeader.Prop.FEnableResizeItemWidth:=False;//True;//拖动有点延迟有问题，要先修复
    ...
    //  Self.HorzScrollBar.OnChange:=Self.DoHorzScrollBar_OnPositionChange;
      ...
      FColumnHeader.Visible:=True;

      FColumns:=TSkinVirtualGridColumns(FColumnHeader.Prop.Items);

      FColumnLayoutsManager:=FColumnHeader.Prop.ListLayoutsManager;
      {$ELSE}
      //表格列列表
      FColumns:=GetColumnsClass.Create(GetColumnClass);
      //表格列布局管理
...
begin
  ...
  begin
      ...
      TSkinFMXEdit(Result).KeyboardType:=ACol.KeyboardType;
...
begin
  ...
  {$IFDEF ColumnHeaderIsControl}
  {$ELSE}
  Result:=TSkinListLayoutsManager;//TSkinVirtualGridColumnLayoutsManager;
  {$ENDIF}
end;

destructor TVirtualGridProperties.Destroy;
begin
  FColumns.FVirtualGridProperties:=nil;
...
//  uBaseLog.OutputDebugString('UpdateScrollBars In DoColumnSizeChange');
  ...
  Self.FListLayoutsManager.DoItemSizeChange(nil,True);
...
begin
  ...
  {$ENDIF}
  {$IFDEF VCL}
  Result:=ScreenScaleSize(Self.FColumnLayoutsManager.StaticItemHeight);
  {$ENDIF}
end;
...
begin
  {$IFDEF ColumnHeaderIsControl}
  Result:=Self.FColumnHeader.Prop.FixedItems;
  {$ELSE}
  Result:=FFixedCols;
  {$ENDIF}
end;
...
//获取客户区矩形,用于调整滚动条的位置
function TVirtualGridProperties.GetClientRect:TRectF;
begin
  Result:=Inherited;
  {$IFDEF FMX}
  Result.Top:=Result.Top
...
begin
  ...
  begin
    {$IFDEF ColumnHeaderIsControl}
    if Self.FColumnHeader<>nil then
    begin
      Self.FColumnHeader.Visible:=True;
      Self.FColumnHeader.Height:=Ceil(Value);
    end;
  ...
  begin
    ...
    if Self.FColumnHeader<>nil then
    begin
      Self.FColumnHeader.Visible:=False;
    end;
    {$ELSE}
    //列表项的顶部偏移
...
begin
  ...
  begin
    {$IFDEF ColumnHeaderIsControl}
    Self.FColumnHeader.Prop.FixedItems:=Value;
    {$ELSE}
    FFixedCols:=Value;
    {$ENDIF}
    Self.Invalidate;
...
function TVirtualGridProperties.GetContentMarginsBottom: Double;
begin
  Result:=Self.FFooterRowHeight*Self.FFooterRowCount;
end;

function TVirtualGridProperties.GetContentMarginsTop: Double;
begin
  Result:=Self.ColumnsHeaderHeight;
end;
...
procedure TVirtualGridProperties.UpdateFooter;
begin
  //
end;
...
//  begin
      ...
      //调用事件,获取外部自定义的编辑控件
      if (AItemDesignerPanelEditControl=nil)
        and Assigned(Self.FSkinVirtualGridIntf.OnGetCellEditControl) then
      begin
...
//  Self.FColumnHeader.BringToFront;
end;
...
begin
      ...
      ACanvas.DrawRect(ADrawColumnMaterial.DrawCellBackColorParam,
                        ACellDrawRect);
...
begin
  ...
  begin
      ...
      begin
        ADrawColumnMaterial:=AColumn.GetCurrentUseMaterial;
      end;

      if ADrawColumnMaterial<>nil then
      begin
        ACanvas.DrawRect(ADrawColumnMaterial.DrawFooterCellBackColorParam,
                          ACellDrawRect);
...
//      end;
    ...
    //if Self.FSkinVirtualGridIntf.Prop.FColumnLayoutsManager.
      ...
      try
          ...
          begin
            ...
            begin
              ...
              //uBaseLog.OutputDebugString('ACellDrawRect'
              //                                          +' I:'+FloatToStr(I)
              //                                          +' '+FloatToStr(ACellDrawRect.Left)
              //                                          +' '+FloatToStr(ACellDrawRect.Top)
              //                                          +' '+FloatToStr(ACellDrawRect.Width)
              //                                          +' '+FloatToStr(ACellDrawRect.Height)
              //                                          );
              //加上水平垂直的偏移
...
begin
  ...
  begin
    ...
    OffsetRectF(AFooterRowDrawRect,ADrawRect.Left,ADrawRect.Top);
    //绘制统计行
...
//                                    and (ALineRect.Left>ADrawRect.Left+Self.FSkinVirtualGridIntf.Prop.GetRealFixedColsDrawRight)
                                  { TODO : 注释掉了 难道FIndicatorWidth为0就必须得画吗 }
//                                    or IsSameDouble(Self.FSkinVirtualGridIntf.Prop.FIndicatorWidth,0)
                                    ) then
                              begin
                                ACanvas.DrawRectLine(ASkinVirtualGridMaterial.DrawGridCellDevideMaterial.FDrawColLineParam,
...
//  end;
  ...
  //存在表格列,要最后吧，因为单元格的列分隔线会画在统计区上面，这样不太好
  if (Self.FSkinVirtualGridIntf.Prop.FColumnLayoutsManager.GetVisibleItemsCount>0) then
  begin
      //绘制统计区
      CustomPaintColumnsFooter(
...
begin
  ...
  begin
    ...
    begin
      ...
      AMouseOverItemDrawItemDesignerPanel:=AMoveOverCol.GetDrawItemDesignerPanel(AMouseOverItem);
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      AMouseOverItemDrawItemDesignerPanel:=AMoveOverCol.GetDrawItemDesignerPanel(AMouseDownItem);
    end;
  end;
          ...
          begin
              ...
              begin
                Self.FSkinCustomListIntf.OnClickItemDesignerPanelChild(
                    Self.FSkinControl,
                    AMouseDownItem,
                    {$IFDEF FMX}TSkinFMXItemDesignerPanel{$ELSE}TSkinItemDesignerPanel{$ENDIF}(AMouseOverItemDrawItemDesignerPanel),
              ...
              //用于一个设计面板共享给多个ListBox使用的时候,
              //可以在ListBox中的此事件分别处理对应的操作
              if Assigned(Self.FSkinVirtualGridIntf.OnClickCellItemDesignerPanelChild) then
              begin
                Self.FSkinVirtualGridIntf.OnClickCellItemDesignerPanelChild(
                    Self.FSkinControl,
                    AMouseDownItem,
                    AMoveOverCol,
                    {$IFDEF FMX}TSkinFMXItemDesignerPanel{$ELSE}TSkinItemDesignerPanel{$ENDIF}(AMouseOverItemDrawItemDesignerPanel),
...
//              {$ENDIF}
              //如果是Edit,那么启动自动编辑
              if (AMouseOverItemDrawItemDesignerPanel.SkinControlType.CurrentHitTestChildControl is TEdit)
//                and TSkinEdit(AMouseOverItemDrawItemDesignerPanel.SkinControlType.CurrentHitTestChildControl).IsAutoEditInItem
                then
              begin
                Self.FSkinVirtualGridIntf.Prop.StartEditingCell(
...
begin
  ...
  //重新计算下需要自动适应的列的宽度
  Self.FSkinVirtualGridIntf.Properties.SetColumnsAutoFitControlWidth;
end;
...
begin
  ...
  FColumnHeaderMaterial:=TSkinColumnHeaderDefaultMaterial.Create(Self);
  FColumnHeaderMaterial.SetSubComponent(True);
  FColumnHeaderMaterial.Name:='ColumnHeaderMaterial';
  FColumnHeaderMaterial.OnChange:=Self.DoChange;
...
begin
  ...
  FreeAndNil(FColumnHeaderMaterial);
...
procedure TSkinVirtualGridDefaultMaterial.SetColumnHeaderMaterial(
  const Value: TSkinColumnHeaderDefaultMaterial);
begin
  FColumnHeaderMaterial.Assign(Value);
end;
...
//end;
//
//function TSkinVirtualGridColumns._AddRef: {$IFDEF LINUX}longint{$ELSE}Integer{$ENDIF};  {$IFDEF LINUX}cdecl{$ELSE}stdcall{$ENDIF};
//begin
...
//end;
//
//function TSkinVirtualGridColumns._Release: {$IFDEF LINUX}longint{$ELSE}Integer{$ENDIF};  {$IFDEF LINUX}cdecl{$ELSE}stdcall{$ENDIF};
//begin
//  if FOwnerInterface <> nil then
...
//end;
//
//function TSkinVirtualGridColumns.QueryInterface({$IFDEF FPC}constref{$ELSE}const{$ENDIF} IID: TGUID; out Obj): {$IFDEF LINUX}longint{$ELSE}HResult{$ENDIF};  {$IFDEF LINUX}cdecl{$ELSE}stdcall{$ENDIF};
////const
...
begin
  inherited;
  if FVirtualGridProperties<>nil then
  begin
    FVirtualGridProperties.Invalidate;
  end;
end;
...
function TSkinVirtualGridColumns.GetDefaultSkinItemClass:TBaseSkinItemClass;
begin
  Result:=TSkinVirtualGridColumn;
end;
...
procedure TSkinVirtualGridColumns.RebuildColumns;
begin
  //
end;

function TSkinVirtualGridColumns.GetState: TSkinGridColumnsState;
begin
  Result := TSkinGridColumnsState((Count > 0) and Items[0].IsStored);
end;

procedure TSkinVirtualGridColumns.SetState(NewState: TSkinGridColumnsState);
begin
...
//end;
//
//function TSkinVirtualGridColumn.QueryInterface({$IFDEF FPC}constref{$ELSE}const{$ENDIF} IID: TGUID;
...
//  FMaterial:=GetColumnMaterialClass.Create(nil);//TSkinVirtualGridColumns(Collection).FVirtualGridProperties.FSkinControl);
  ...
  TComponent(FMaterial).SetSubComponent(True);
  ...
  FDefaultItemStyleSetting.FOnChangeItem:=Self.DoNewListItemStyleFrameCacheChangeItem;
...
begin
  ...
  begin
    Result:=Self.FRefMaterial;
  end
  else
  begin
    Result:=TSkinVirtualGridColumnMaterial(Self.FMaterial);
  end;
...
begin
  ...
  begin
    Result:=FDefaultItemStyleSetting.GetInnerItemDesignerPanel(ASkinItem);
  end;
end;
...
begin
  if FDefaultItemStyleSetting<>nil then
  begin
...
//    FreeAndNil(FItemBindingControl);
    ...
    //      FItemBindingControl:=InitItemBindingControl(FSkinControl);
          ...
          {$ENDIF}
          {$IFDEF FMX}
          FSkinControl.Margins.Left:=5;
          FSkinControl.Margins.Top:=5;
          FSkinControl.Margins.Right:=5;
          FSkinControl.Margins.Bottom:=5;
          {$ENDIF}
          ...
          FSkinControl.Align:={$IFDEF FMX}TAlignLayout.Client{$ELSE}alClient{$ENDIF};
        end;
    end;
...
begin
  ...
  begin
    uBaseLog.HandleException(nil,'TSkinVirtualGridColumn.SetDefaultItemStyle error');
  end;
end;
...
begin
  ...
  begin
    uBaseLog.HandleException(nil,'TSkinVirtualGridColumn.SetItemDesignerPanel error');
  end;
end;
...
//    UnUseCurrentUseMaterial;
    ...
    if FRefMaterial<>nil then
    begin
      Self.FRefMaterial.RemoveFreeNotification(TSkinVirtualGridColumns(Self.Collection).FVirtualGridProperties.FSkinControl);
    end;
    ...
    if FRefMaterial<>nil then
    begin
      Self.FRefMaterial.FreeNotification(TSkinVirtualGridColumns(Self.Collection).FVirtualGridProperties.FSkinControl);
    end;
...
procedure TSkinVirtualGridColumn.DoNewListItemStyleFrameCacheChangeItem(
...
//  FDrawCaptionParam.FIsMustStoreFontColor:=True;
  ...
  FDrawCellBackColorParam:=CreateDrawRectParam('DrawCellBackColorParam','单元格背景绘制参数');
  FDrawFooterCellBackColorParam:=CreateDrawRectParam('DrawFooterCellBackColorParam','统计行单元格背景绘制参数');
end;
...
//  FreeAndNil(FDrawCaptionParam);
  ...
  FreeAndNil(FDrawCellBackColorParam);
  FreeAndNil(FDrawFooterCellBackColorParam);
  inherited;
end;

function TSkinVirtualGridColumnMaterial.GetBackColor: TDrawRectParam;
begin
  Result:=FDrawItemBackColorParam;
end;

function TSkinVirtualGridColumnMaterial.GetDrawCaptionParam: TDrawTextParam;
begin
  Result:=FDrawItemCaptionParam;
end;
...
procedure TSkinVirtualGridColumnMaterial.SetBackColor(const Value: TDrawRectParam);
begin
...
procedure TSkinVirtualGridColumnMaterial.SetDrawCellBackColorParam(
  const Value: TDrawRectParam);
begin
  FDrawCellBackColorParam.Assign(Value);
end;
...
procedure TSkinVirtualGridColumnMaterial.SetDrawFooterCellBackColorParam(
  const Value: TDrawRectParam);
begin
  FDrawFooterCellBackColorParam.Assign(Value);
end;
...
function TSkinVirtualGridRows.GetDefaultSkinItemClass: TBaseSkinItemClass;
begin
...
begin
  ...
  begin
    Result:=TSkinVirtualGridRowLayoutsManager(Owner.GetListLayoutsManager).FVirtualGridProperties.CalcContentWidth;
...
procedure TSkinVirtualGrid.SetControlArrayByBindItemField(const AFieldName:String;
                                                        const AFieldValue:ISuperArray;
                                                        APropertyName:String;
                                                        ABindItemFieldSetting:TBindItemFieldSetting;
                                                        ASkinItem:TObject;
...
var
  I: Integer;
  AColumn:TSkinVirtualGridColumn;
  AKeyArray:TStringDynArray;
begin
  //给控件设置表格列
  if (AFieldValue<>nil) and (AFieldValue.Length>0) then
  begin
    Self.Prop.Columns.BeginUpdate;
    try
      //判断是否不一样了,结构不一样了就清空
      AKeyArray:=GetJsonNameArray(AFieldValue.O[0]);

      Self.Prop.Columns.Clear;
      for I := 0 to Length(AKeyArray)-1 do
      begin
        AColumn:=TSkinVirtualGridColumn(Self.Prop.Columns.Add);
        AColumn.SetBindItemFieldName(AKeyArray[I]);
        AColumn.Caption:=AKeyArray[I];
      end;
...
//end;
//
//function TSkinVirtualGrid.GetColumnHeaderMaterial: TSkinColumnHeaderDefaultMaterial;
//begin
//  Result:=TSkinColumnHeaderDefaultMaterial(FColumnHeader.SelfOwnMaterial);
//end;
