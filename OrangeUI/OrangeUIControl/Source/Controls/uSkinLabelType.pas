...
begin
  ...
  begin
    ...
    begin
      ACanvas.DrawText(TSkinLabelMaterial(ASkinMaterial).FDrawCaptionParam,
...
begin
  ...
  begin
    ASize:=GetSuitControlStringContentSize(
            ...
            TSkinLabelMaterial(Self.FSkinControlIntf.GetCurrentUseMaterial).FDrawCaptionParam
            );
...
procedure TSkinLabel.ProcessItemColor(AItemColorType:TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType;AItemColor:TDelphiColor;var AOldColor:TDelphiColor);
begin
...
procedure TSkinLabel.RestoreItemColor(AItemColorType:TSkinItemColorType;AItemColorFieldName:String;AItemColorFieldSetType:TSkinItemColorSetType;AItemColor:TDelphiColor;AOldColor:TDelphiColor);
begin
  case AItemColorType of
    sictNone: ;
    sictBackColor:
...
initialization
  RegisterClasses([TSkinLabel]);
  RegisterClasses([TSkinRollLabel]);
