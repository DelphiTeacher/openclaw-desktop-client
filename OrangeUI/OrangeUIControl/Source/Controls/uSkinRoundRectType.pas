...
initialization
  RegisterClasses([TSkinRoundRect]);
  //开关条
  RegisterSkinControlStyle('SkinRoundRect',TSkinRoundRectDefaultType,TSkinRoundRectDefaultMaterial,TRoundRectProperties,Const_Default_ComponentType,True);
