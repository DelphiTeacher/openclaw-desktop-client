...
procedure TListViewProperties.SaveToJson(ASuperObject: ISuperObject);
begin
  inherited;
...
procedure TListViewProperties.LoadFromJson(ASuperObject: ISuperObject);
begin
  inherited;
//    ListLayoutsManager.FViewType:=lvtIcon;
//    ListLayoutsManager.FItemCountPerLine:=-1;
...
function TControlLayoutItem.GetIsMouseOver: Boolean;
begin
  Result:=False;
end;
...
//            AItemRect.Left:=AItemRect.Left;//+ScreenScaleSize(LayoutSetting.margins_left);//+AParentMarginsLeft;
//            AItemRect.Right:=AItemRect.Right;//+ScreenScaleSize(LayoutSetting.margins_left);//+AParentMarginsLeft;
//            AItemRect.Top:=AItemRect.Top;//+ScreenScaleSize(LayoutSetting.margins_top);//+AParentMarginsTop;
//            AItemRect.Bottom:=AItemRect.Bottom;//+ScreenScaleSize(LayoutSetting.margins_top);//+AParentMarginsTop;
...
//function TControlLayoutItems.GetOwnerProperties: TObject;
//begin
//  Result:=nil;
//end;
