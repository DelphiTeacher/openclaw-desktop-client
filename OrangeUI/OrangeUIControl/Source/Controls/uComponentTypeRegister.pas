...
begin
  ...
  {$IFDEF FMX}
  RegisterComponents('OrangeUIComponent',[TFrameContext]);
  RegisterComponents('OrangeUIComponent',[TSkinMessageBox]);
  {$ENDIF}
  RegisterComponents('OrangeUIComponent',[TJsonBindDataSource]);
  RegisterComponents('OrangeUIComponent',[TRestDBDataSource]);
  RegisterComponents('OrangeUIComponent',[TRestConnection]);
  RegisterComponents('OrangeUIComponent',[TRestDBConnection]);
  RegisterComponents('OrangeUIComponent',[TRestIntfDataSource]);
  RegisterComponents('OrangeUIComponent',[TParamsDataSource]);
...
//  {$ENDIF}
  ...
  RegisterComponents('OrangeUIConrol',[TSkinColumnHeader]);
...
//  RegisterComponents('OrangeUIConrol',[TSkinFMXSelectDateAreaButton]);
  RegisterComponents('OrangeUIConrol',[TSkinFMXLabel]);
...
//  RegisterComponents('OrangeUIConrol',[TSkinFMXRegExTagLabelView]);
...
//  RegisterComponents('OrangeUIConrol',[TSkinFMXVirtualGrid]);
  ...
  RegisterComponents('OrangeUIConrol',[TProcessNativeControlModalShowPanel]);
  ...
  RegisterComponents('OrangeUIConrol',[TSkinWinNormalForm]);
...
//  RegisterComponents('OrangeUIConrol',[TSkinWinMemo]);
  ...
  RegisterComponents('OrangeUIMaterial',[TSkinVirtualGridColumnMaterial]);
