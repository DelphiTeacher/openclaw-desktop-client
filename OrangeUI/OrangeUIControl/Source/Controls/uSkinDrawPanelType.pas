...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ACanvas.DrawPathData(Self.FSkinDrawPanelIntf.Prop.FDrawPathDataList[I],ADrawRect,nil);
      end;

      if Self.FSkinDrawPanelIntf.Prop.FDrawPathData<>nil then
      begin
        ACanvas.DrawPathData(Self.FSkinDrawPanelIntf.Prop.FDrawPathData,ADrawRect,nil);
      end;
    end;
...
begin
  ...
  begin
    ...
    Result:=CreateCurrentEngineSkinPicture;
...
//    {$ENDIF}
    ...
    //创建画布
    ResultPictureDrawCanvas:=CreateDrawCanvas('TSkinDrawPanelType.CombinePicture');
    try
...
//            ,TCanvasQuality.HighQuality);
        ...
        begin
          ...
          try
              ...
              begin
                  //控件大小
                  PathDataPicture:=CreateCurrentEngineSkinPicture;
                  ...
                  PathDataPictureDrawCanvas:=CreateDrawCanvas('TSkinDrawPanelType.CombinePicture');
                  {$IFDEF FMX}
              ...
              //            ,TCanvasQuality.HighQuality);
                  ...
                  try
                    ...
                    begin
                      ...
                      for I := 0 to Self.FSkinDrawPanelIntf.Prop.FDrawPathDataList.Count-1 do
                      begin
                        PathDataPictureDrawCanvas.DrawPathData(Self.FSkinDrawPanelIntf.Prop.FDrawPathDataList[I],RectF(0,0,AWidth,AHeight),nil);
                      end;
...
//    FPictureCanvas:=nil;
    ...
    FPicture:=CreateCurrentEngineSkinPicture;
    FPicture.OnChange:=Self.DoPictureChanged;

    FBackGndPicture:=CreateCurrentEngineSkinPicture;
