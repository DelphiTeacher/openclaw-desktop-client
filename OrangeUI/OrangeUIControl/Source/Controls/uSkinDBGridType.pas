...
//    function GetValueType1(ARow:TBaseSkinItem):TVarType;override;
    ...
    procedure SetBindItemFieldName(const Value: String);override;
    procedure SetBindItemFieldName1(const Value: String);override;
  public
    IsImage:Boolean;
...
//                        ItemClass: TCollectionItemClass);override;
  public
    ...
    ///   </para>
    /// </summary>
    procedure RebuildColumns;override;
...
//    procedure UpdateIme;
    ...
    //更新统计汇总
    procedure UpdateFooter;override;
...
begin
  ...
  begin
    ...
    {$ENDIF}
    {$IFDEF FPC}
    Result := DataSet.Fields[FFieldMap[ColIndex]];
    {$ENDIF}
  end
  else
  begin
...
begin
  ...
  begin
    Raise EInvalidGridOperation.Create('TooManyColumns');
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        DatabaseError('DataSetUnidirectional');
      end;
    end;
  end;
...
begin
  ...
  //        with FDatalink.Dataset.FieldList[I] do
        ...
        {$ENDIF}
        {$IFDEF FPC}
        for I := 0 to FDatalink.Dataset.Fields.Count - 1 do
        begin
  //        with FDatalink.Dataset.Fields[I] do
          if FDatalink.Dataset.Fields[I].Visible then
          begin
            Datalink.AddMapping(FDatalink.Dataset.Fields[I].FieldName);
          end;
        end;
        {$ENDIF}
...
procedure TSkinDBGridColumn.SetBindItemFieldName(const Value: String);
begin
  FieldName:=Value;
end;

procedure TSkinDBGridColumn.SetBindItemFieldName1(const Value: String);
begin
...
//创建列表项
function TSkinDBGridColumns.GetDefaultSkinItemClass:TBaseSkinItemClass;
begin
  Result:=TSkinDBGridColumn;
end;
...
begin
  ...
  begin
    Raise EInvalidGridOperation.Create('DataSetClosed');
  end;
...
function TSkinDBGridRows.GetDefaultSkinItemClass: TBaseSkinItemClass;
begin
...
function TSkinDBGrid.GetColumnsClass: TSkinVirtualGridColumnsClass;
begin
  Result:=TSkinDBGridColumns;
