...
type
  ...
  protected
    ...
    procedure SetIsUseSystemStyle(Value:Boolean);
  protected
    //缓存位图
...
//    function GetChildControl(Index:Integer):TChildControl;
  public
    FIsUseSystemStyle:Boolean;
    //procedure SetBounds(ABoundsRect:TRectF);

    constructor Create(AOwner:TComponent);override;
    destructor Destroy;override;
  published
    property IsUseSystemStyle:Boolean read FIsUseSystemStyle write SetIsUseSystemStyle default False;
...
procedure TSkinWinMemo.SetIsUseSystemStyle(Value:Boolean);
begin
  if FIsUseSystemStyle<>Value then
  begin
    FIsUseSystemStyle:=Value;
//    if FIsUseSystemStyle then
//    begin
...
begin
  Inherited;
  if FIsUseSystemStyle then Exit;
  Self.NCPaintWindow;
  Self.Invalidate;
end;
  ...
  Try
    ...
    begin
      ...
      StretchBlt(DC,0,0,
                  ...
                  Self.BufferBitmap.DrawCanvas.Handle,0,0,
                  Self.Width,Self.FBorderMargins.Top,
                  SRCCOPY);
      StretchBlt(DC,0,Self.Height-Self.FBorderMargins.Bottom,
                  Self.Width,Self.FBorderMargins.Bottom,
                  Self.BufferBitmap.DrawCanvas.Handle,0,Self.Height-Self.FBorderMargins.Bottom,
                  Self.Width,Self.FBorderMargins.Bottom,
                  SRCCOPY);
      StretchBlt(DC,0,Self.FBorderMargins.Top,
                  ...
                  Self.BufferBitmap.DrawCanvas.Handle,0,Self.FBorderMargins.Top,
                  Self.FBorderMargins.Left,//+Self.GetCustomWMNCCalcSizeLeftWidth,
                  Self.Height-Self.FBorderMargins.Top-Self.FBorderMargins.Bottom,
                  SRCCOPY);
      StretchBlt(DC,Self.Width-Self.FBorderMargins.Right,//-Self.GetCustomWMNCCalcSizeRightWidth,
                  ...
                  Self.Height-Self.FBorderMargins.Top-Self.FBorderMargins.Bottom,
                  Self.BufferBitmap.DrawCanvas.Handle,Self.Width-Self.FBorderMargins.Right,//-Self.GetCustomWMNCCalcSizeRightWidth,
                  Self.FBorderMargins.Top,
                  Self.FBorderMargins.Right,//+Self.GetCustomWMNCCalcSizeRightWidth,
                  Self.Height-Self.FBorderMargins.Top-Self.FBorderMargins.Bottom,
                  SRCCOPY);
...
//  begin
    ...
    begin
      Bitblt(FTransparentBitmap.Canvas.Handle,
             ...
             Self.FBufferBitmap.DrawCanvas.Handle,
             Self.FBorderMargins.Left,
             Self.FBorderMargins.Top,
             SRCCOPY
              );
...
//procedure TSkinWinMemo.SetBounds(ALeft, ATop, AWidth, AHeight: TControlSize);
//begin
//  Self.SetBounds(ControlSize(ALeft), ControlSize(ATop), ControlSize(AWidth), ControlSize(AHeight));
//end;
//
//procedure TSkinWinMemo.SetBounds(ABoundsRect:TRectF);
//begin
//  Self.SetBounds(ControlSize(ABoundsRect.Left), ControlSize(ABoundsRect.Top), ControlSize(ABoundsRect.Width), ControlSize(ABoundsRect.Height));
//end;

initialization
  RegisterClasses([TSkinMemo]);
