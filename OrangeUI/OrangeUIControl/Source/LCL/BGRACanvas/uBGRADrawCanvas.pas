...
//    Stroke:TStrokeBrush;
  public
    ...
    procedure Prepare(ADrawCanvas:TObject);override;
  public
...
function TBGRADrawCanvas.DrawPathData(ADrawPathData: TBaseDrawPathData;const ADrawRect:TRectF;APathActions:TPathActionCollection): Boolean;
begin
...
function TBGRADrawCanvas.FillPathData(ADrawPathParam:TDrawPathParam;ADrawPathData: TBaseDrawPathData;const ADrawRect:TRectF;APathActions:TPathActionCollection): Boolean;
begin
//  //创建画刷
//  Self.FBGRACanvas.Fill.Kind:=FMX.Graphics.TBrushKind.{$IF CompilerVersion >= 35.0}Solid{$ELSE}bkSolid{$IFEND};
//  Self.FBGRACanvas.Fill.Color:=ADrawPathParam.CurrentEffectFillDrawColor.Color;
...
procedure TBGRADrawPathData.Prepare(ADrawCanvas: TObject);
begin
  Self.FBGRACanvas2D:=TBGRADrawCanvas(ADrawCanvas).FBGRACanvas2D;
