...
procedure TfrmSkinPictureListPropertyEditor.SetSkinPictureList(const Value: TDrawPictureCollection);
var
  ListItem:TListBoxItem;
  ListItemIndex:Integer;
  I: Integer;
...
begin
  ...
  begin
    ...
    FDrawPicturePersistent.DrawPicture:=FPictureList[Self.ListBox1.Selected.Index];
