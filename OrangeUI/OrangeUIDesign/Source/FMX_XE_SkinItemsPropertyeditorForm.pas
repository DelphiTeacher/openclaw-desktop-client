...
type
  ...
  TfrmSkinItemsPropertyEditor = class({$IFDEF MY_PROGRAM_DESIGNER}TForm{$ELSE}TFmxDesignWindow{$ENDIF},
                                       IFreeNotification)
    ItemsTree: TTreeView;
...
//  begin
//    ShowMessage('SelectedItems is nil');
//    Exit;
//  end;
...
//  ShowMessage('2');
//  ShowMessage('SelectedItems.Count:'+IntToStr(SelectedItems.Count));
  SelectedItems.BeginUpdate;
  try
    //要BeginUpdate包起来,不然会报错
