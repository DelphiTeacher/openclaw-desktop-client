...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TSkinItems),
                          //父属性
                          nil,
                          //属性名称
                          'Items',
...
//      RegisterComponentEditor(TSkinFMXVirtualList,TVirtualListEditor);
      ...
      RegisterComponentEditor(TSkinListBox,TListBoxEditor);
      ...
      RegisterSelectionEditor(TSkinListBox,TCustomListSelectionEditor);

      {$IFDEF OPENSOURCE_VERSION}
      //开源版没有ListView,TreeView,Grid
      {$ELSE}
      RegisterSelectionEditor(TSkinFMXListView,TCustomListSelectionEditor);
      RegisterSelectionEditor(TSkinListView,TCustomListSelectionEditor);
...
//      RegisterComponentEditor(TSkinWinVirtualList,TVirtualListEditor);
      ...
      {$ELSE}
        ...
        RegisterComponentEditor(TSkinListView,TListViewEditor);
        ...
        RegisterComponentEditor(TSkinItemGrid,TItemGridEditor);
        RegisterComponentEditor(TSkinWinDBGrid,TDBGridEditor);
        RegisterComponentEditor(TSkinDBGrid,TDBGridEditor);
      {$ENDIF}
      ...
      {$ELSE}
        ...
        RegisterSelectionEditor(TSkinItemGrid,TCustomListSelectionEditor);
        RegisterSelectionEditor(TSkinWinDBGrid,TCustomListSelectionEditor);
        RegisterSelectionEditor(TSkinDBGrid,TCustomListSelectionEditor);
      {$ENDIF}
  {$ENDIF}
...
constructor TSkinItemsProperty.Create(const ADesigner: IDesigner;
  APropCount: Integer);
begin
  inherited;
  FAllowChild := False;
