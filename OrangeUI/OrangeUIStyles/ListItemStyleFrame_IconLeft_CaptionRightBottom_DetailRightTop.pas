...
unit ListItemStyleFrame_IconLeft_CaptionRightBottom_DetailRightTop;
...
type
  TFrameIconLeft_CaptionRightBottom_DetailRightTopListItemStyle = class(TFrameBaseListItemStyle)
...
procedure TFrameIconLeft_CaptionRightBottom_DetailRightTopListItemStyle.ItemDesignerPanelResize(
  Sender: TObject);
begin
  inherited;
...
initialization
  RegisterListItemStyle('IconLeft_CaptionRightBottom_DetailRightTop',TFrameIconLeft_CaptionRightBottom_DetailRightTopListItemStyle);

finalization
  UnRegisterListItemStyle(TFrameIconLeft_CaptionRightBottom_DetailRightTopListItemStyle);
