...
unit ListItemStyleFrame_CustomerRank;
...
type
  TFrameCustomerRankListItemStyle = class(TFrameBaseListItemStyle)
    ...
    btnRankUp: TSkinFMXButton;
    btnRankDown: TSkinFMXButton;
...
procedure TFrameCustomerRankListItemStyle.ItemDesignerPanelResize(
  Sender: TObject);
begin
  inherited;
...
initialization
  RegisterListItemStyle('CustomerRank',TFrameCustomerRankListItemStyle);

finalization
  UnRegisterListItemStyle(TFrameCustomerRankListItemStyle);
