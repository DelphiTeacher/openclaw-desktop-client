...
unit ListItemStyleFrame_GrayCaptionLeftAutoSize_DetailLeft;
...
type
  TFrameListItemStyle_GrayCaptionLeftAutoSize_DetailLeft = class(TFrame,IFrameBaseListItemStyle)
...
constructor TFrameListItemStyle_GrayCaptionLeftAutoSize_DetailLeft.Create(AOwner: TComponent);
begin
  inherited;
...
function TFrameListItemStyle_GrayCaptionLeftAutoSize_DetailLeft.GetItemDesignerPanel: TSkinItemDesignerPanel;
begin
  Result:=ItemDesignerPanel;
end;

procedure TFrameListItemStyle_GrayCaptionLeftAutoSize_DetailLeft.ItemDesignerPanelPrepareDrawItem(
...
initialization
  RegisterListItemStyle('GrayCaptionLeftAutoSize_DetailLeft',TFrameListItemStyle_GrayCaptionLeftAutoSize_DetailLeft);

finalization
  UnRegisterListItemStyle(TFrameListItemStyle_GrayCaptionLeftAutoSize_DetailLeft);
