...
unit ListItemStyleFrame_CalendarItem;
...
type
  TFrameCalendarItemListItemStyle = class(TFrameBaseListItemStyle)
    ...
    pnlItem: TSkinFMXPanel;
    pnlRedLine: TSkinFMXPanel;
...
procedure TFrameCalendarItemListItemStyle.ItemDesignerPanelResize(
  Sender: TObject);
begin
  inherited;
...
initialization
  RegisterListItemStyle('CalendarItem',TFrameCalendarItemListItemStyle);

finalization
  UnRegisterListItemStyle(TFrameCalendarItemListItemStyle);
