...
procedure TFrameRegister.Clear;//(AText:String);
begin
  //用户头像
...
//function TFrameRegister.GetCurrentPorcessControl(AFocusedControl: TControl)
//  : TControl;
//begin
...
procedure TFrameRegister.Load;//(AUserName, AUserHeadPicFilePath, AWxOpenID,
//  AWxAuthToken: String;
//  AAlipayOpenID:String;
//  AAlipayAuthToken:String);
var
