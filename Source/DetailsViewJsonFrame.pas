...
type
  TFrameDetailsViewJson = class(TFrame
...
//    procedure tteDetailsViewJsonBegin(ATimerTask: TTimerTask);
//    procedure tteDetailsViewJsonExecute(ATimerTask: TTimerTask);
//    procedure tteDetailsViewJsonExecuteEnd(ATimerTask: TTimerTask);
...
//    procedure DoLoadData(ADataJson:ISuperObject);
    procedure Load(AReportName:String; ADataJson:ISuperObject);overload;
...
var
  GlobalDetailsViewJsonFrame:TFrameDetailsViewJson;
...
{ TFrameDetailsViewJson }

procedure TFrameDetailsViewJson.AlignControls;
begin
...
// 编辑
procedure TFrameDetailsViewJson.btnEditClick(Sender: TObject);
begin
  // 跳转到主表编辑页面EditBillFrame
  HideFrame;
  ShowFrame(TFrame(GlobalEditBillFrame),TFrameEditBill);
  GlobalEditBillFrame.Load(FReportName, FDataJson);
end;

procedure TFrameDetailsViewJson.btnOKClick(Sender: TObject);
//var
//  I: Integer;
begin
  //可以不需要指定维修工
...
//  //调用派工接口
//  Self.tteDetailsViewJson.Run;

end;

procedure TFrameDetailsViewJson.btnReturnClick(Sender: TObject);
begin
...
//procedure TFrameDetailsViewJson.btnSelectRepairManClick(Sender: TObject);
//var
...
//procedure TFrameDetailsViewJson.DoGetDataForSelectRepairManPopupMenuFrame(ATimerTask: TTimerTask);
//begin
//  try
//      //出错
...
//function TFrameDetailsViewJson.Check: Boolean;
//begin
//end;

procedure TFrameDetailsViewJson.Clear;
begin
...
constructor TFrameDetailsViewJson.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TFrameDetailsViewJson.Destroy;
begin
...
procedure TFrameDetailsViewJson.Load(AReportName:String; ADataJson: ISuperObject);
var
  I: Integer;
  AItem:TSkinItem;
...
begin
  ...
  try
    ...
    begin
          ...
          if FDetailVisibleFields.IndexOf(AParamNames[I]) <> -1 then
          begin
            continue;
          end;
...
//function TFrameDetailsViewJson.GetCurrentPorcessControl(
//  AFocusedControl: TControl): TControl;
//begin
//  Result:=AFocusedControl;
//end;
//
//function TFrameDetailsViewJson.GetVirtualKeyboardControlParent: TControl;
//begin
//  Result:=Self;
//end;
//
//procedure TFrameDetailsViewJson.DoSelectRepairManFromMultiSelectFrame(
...
//end;
//
//procedure TFrameDetailsViewJson.edtHourChange(Sender: TObject);
//begin
//  SyncButtonState;
//end;
//
//procedure TFrameDetailsViewJson.edtHourChangeTracking(Sender: TObject);
//begin
//  SyncButtonState;
//end;

//procedure TFrameDetailsViewJson.Load(ADataJson: ISuperObject);
//begin
//  DoLoadData(ADataJson);
////  Self.tteGetRepairCarOrder.Run;
//end;

//procedure TFrameDetailsViewJson.idpRepairItemClick(Sender: TObject);
//begin
//
//end;

procedure TFrameDetailsViewJson.Sync(ADataJson: ISuperObject;ANeedDisplayColumns:String);
var
  I: Integer;
  AItem:TSkinItem;
...
procedure TFrameDetailsViewJson.lvDataClickItem(AItem: TSkinItem);
var
  AIndex:Integer;
  I: Integer;
begin
...
procedure TFrameDetailsViewJson.lvDataNewListItemStyleFrameCacheInit(Sender: TObject;
  AListItemTypeStyleSetting: TListItemTypeStyleSetting;
  ANewListItemStyleFrameCache: TListItemStyleFrameCache);
begin
...
//function TFrameDetailsViewJson.SaveToJson: ISuperObject;
//var
//  I: Integer;
//  AStringList:TStringList;
...
//end;
//
//procedure TFrameDetailsViewJson.sbcClientResize(Sender: TObject);
//begin
//  Self.AlignControls;
//end;

//procedure TFrameDetailsViewJson.Select(ACaption, ADataJsonStr: String);
//var
//  ASuperObject:ISuperObject;
//begin
...
//procedure TFrameDetailsViewJson.SyncButtonState;
////var
////  ANumber:Double;
////  APrice:Double;
//begin
...
//procedure TFrameDetailsViewJson.tteDetailsViewJsonBegin(ATimerTask: TTimerTask);
//begin
//  ShowWaitingFrame(Self,'保存中...');
//end;
//
//procedure TFrameDetailsViewJson.tteDetailsViewJsonExecute(ATimerTask: TTimerTask);
//var
...
//end;
//
//procedure TFrameDetailsViewJson.tteDetailsViewJsonExecuteEnd(ATimerTask: TTimerTask);
//var
//  ASuperObject:ISuperObject;
//begin
//  try
...
//end;
//
//procedure TFrameDetailsViewJson.tteGetRepairCarOrderBegin(ATimerTask: TTimerTask);
//begin
//  ShowWaitingFrame(Self,'加载中...');
//
//end;
//
//procedure TFrameDetailsViewJson.tteGetRepairCarOrderExecute(
...
//end;
//
//procedure TFrameDetailsViewJson.tteGetRepairCarOrderExecuteEnd(
//  ATimerTask: TTimerTask);
//var
//  ASuperObject:ISuperObject;
//begin
