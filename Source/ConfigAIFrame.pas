...
procedure TFrameConfigAI.btnAddModelClick(Sender: TObject);
var
...
procedure TFrameConfigAI.btnDownloadOllamaClick(Sender: TObject);
begin
  //打开网页让它下载安装即可
  //安装Ollama
...
procedure TFrameConfigAI.btnSaveClick(Sender: TObject);
var
...
constructor TFrameConfigAI.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TFrameConfigAI.Destroy;
begin
...
procedure TFrameConfigAI.DoModalResultFromOpenGPSMessageBox(AMessageBoxFrame: TObject);
var
  ADesc:String;
begin
...
procedure TFrameConfigAI.DoOneInputMessageBoxFrameModalResult(AMessageBoxFrame: TObject);
begin
...
procedure TFrameConfigAI.Load(AChannelJson:ISuperObject;AOfficialConfigedJson:ISuperObject;AOllamaConfigedJson:ISuperObject);
begin
...
procedure TFrameConfigAI.lvLocalModelsClickItemDesignerPanelChild(Sender: TObject; AItem: TBaseSkinItem; AItemDesignerPanel: TSkinFMXItemDesignerPanel; AChild: TFmxObject);
begin
...
procedure TFrameConfigAI.lvLocalModelsPrepareDrawItem(Sender: TObject; ACanvas: TDrawCanvas; AItemDesignerPanel: TSkinFMXItemDesignerPanel; AItem: TSkinItem; AItemDrawRect: TRect);
var
...
procedure TFrameConfigAI.lvOfficialModelsClickItemDesignerPanelChild(Sender: TObject; AItem: TBaseSkinItem; AItemDesignerPanel: TSkinFMXItemDesignerPanel; AChild: TFmxObject);
begin
...
procedure TFrameConfigAI.lvOfficialModelsPrepareDrawItem(Sender: TObject; ACanvas: TDrawCanvas; AItemDesignerPanel: TSkinFMXItemDesignerPanel; AItem: TSkinItem;
  AItemDrawRect: TRect);
var
  AFrame:TFrameIconCaption_RightGrayButton_InstallModelListItemStyle;
begin
...
procedure TFrameConfigAI.SkinFMXPageControl1Change(Sender: TObject);
begin
  //
...
procedure TFrameConfigAI.SyncModels;
var
  I: Integer;
