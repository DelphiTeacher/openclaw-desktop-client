...
type
  TFrameConfigAIList = class(TFrame)
...
constructor TFrameConfigAIList.Create(AOwner: TComponent);
begin
  inherited;

end;

destructor TFrameConfigAIList.Destroy;
begin

  inherited;
end;

procedure TFrameConfigAIList.Load;
var
  I: Integer;
  ASkinItem:TSkinItem;
...
procedure TFrameConfigAIList.lvChannelClickItem(AItem: TSkinItem);
begin
  //配置该AI渠道
...
procedure TFrameConfigAIList.lvChannelNewListItemStyleFrameCacheInit(Sender: TObject; AListItemTypeStyleSetting: TListItemTypeStyleSetting;
...
procedure TFrameConfigAIList.tteLoadExecute(ATimerTask: TTimerTask);
begin
