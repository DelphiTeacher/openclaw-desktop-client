...
//    NowHaveImage:Boolean;
    ...
    procedure DoSelectFileFromDevice(Sender: TObject; AFileNameList: TStringList);
...
// 选择文件
procedure TFrameAddPictureListSub.DoSelectFileFromDevice(Sender: TObject;
...
begin
  {$IFDEF FMX}
    ...
    for AFileName in AFileNameList do
    begin

      AListViewItem:=AddItem;
      AListViewItem.ItemType:= sitItem2;
      AListViewItem.Caption:= AFileName;
...
//                      {$IFDEF ANDROID}
                        ...
                        GlobalTakePictureMenuFrame.OnPickFile:=DoSelectFileFromDevice;
//                      {$ELSE}
